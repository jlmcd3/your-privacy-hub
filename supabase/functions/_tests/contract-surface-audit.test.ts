...
// Reconciled: cppa_risk (1/8), cppa_admt (2/8), cppa_cyber (3/8), dpia (4/8),
// li_assessment (5/8), governance (6/8), ir_playbook (7/8), biometric (8/8),
// dpa (closes series — 8/8 tools now FATAL, SAMPLES-CONTRACT series COMPLETE).
