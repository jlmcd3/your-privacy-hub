...
Deno.test("W16 BUILD_STAMP advanced to w16-risk-collapsecov@ (or w18 successor)", () => {
  assert(BUILD_STAMP.startsWith("w16-risk-collapsecov@") || BUILD_STAMP.startsWith("w18-risk-collapsecov2@") || BUILD_STAMP.startsWith("w18-risk-vocabscrub@") || BUILD_STAMP.startsWith("w19-risk-turnb@") || BUILD_STAMP.startsWith("w20-risk-turnb@") || BUILD_STAMP.startsWith("band-realignment-t2a@") || BUILD_STAMP.startsWith("ltp-risk-item217-hook-authz-repair-outside-guard@"), `unexpected BUILD_STAMP: ${BUILD_STAMP}`);
});
