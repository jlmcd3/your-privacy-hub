...
export const CPPA_RISK_TOOL_MODULE: ToolModule = {
  ...
  extraRules: [
    ...
    "AUDIT TRIGGERS ARE INDEPENDENT: the § 7120(b) significant-risk categories (deriving 50% or more of annual revenue from selling or sharing personal information; processing the personal information of more than 250,000 consumers or households; processing the sensitive personal information of more than 50,000 consumers) are INDEPENDENT alternatives. Never state or imply that a § 7120(b) volume category applies only 'in conjunction with' a § 1798.140(d) business-definition prong — the business definition determines whether the CCPA applies at all; § 7120(b) then determines the audit obligation on its own terms. Where a subdivision letter is not present in the supplied context, cite '§ 7120(b)' without inventing the letter.",
  ].join("\n"),
