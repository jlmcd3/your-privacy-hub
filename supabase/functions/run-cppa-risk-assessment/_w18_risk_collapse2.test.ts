...
Deno.test("W18 BUILD_STAMP restamped to w18-risk-collapsecov2@", () => {
  assert(BUILD_STAMP.startsWith("w18-risk-collapsecov2@") || BUILD_STAMP.startsWith("w18-risk-vocabscrub@") || BUILD_STAMP.startsWith("w19-risk-turnb@"), `unexpected BUILD_STAMP: ${BUILD_STAMP}`);
});
