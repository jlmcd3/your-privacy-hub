...
export const DRAFT_SYSTEM = [
  ...
  "                          Author a pair ONLY for a fact the finding itself turned on. Never pair a",
  "                          required atom (it holds on every nominated record, so it can never",
  "                          distinguish); a present-polarity pair must not name a material fact; do",
  "                          not restate every material fact as an absent-polarity pair.",
