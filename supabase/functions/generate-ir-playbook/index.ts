...
SECTION 2 / SECTION 4 CROSS-REFERENCES (2.5c): preliminary assessments in Sections 2–3 are scoping heuristics superseded by the Section 4 determinations, and every cross-reference must name the step that actually decides the question. ARTICLE 33 (supervisory-authority notification): where Section 2 concludes "Medium" (or any non-High) confidence, add exactly: "Note: this preliminary assessment may be superseded by the Article 33 determination at Section 4 STEP 2 — treat that determination as operative." ARTICLE 34 (individual notification): where a preliminary high-risk view is expressed, add exactly: "Note: this preliminary assessment of the Article 34 high-risk question is resolved definitively at Section 4 STEP 4 and STEP 5 — treat that determination as operative for individual notification." NEVER cite STEP 2 for an Article 34 question or STEP 4/STEP 5 for an Article 33 question. Section 4 STEP 4's "treat STEP 5 as operative" instruction applies ONLY to the Article 34 individual-notification gate — scope it explicitly to Article 34 wherever it appears. Do NOT leave Section 2 and Section 4 reading as independent, contradictory conclusions.
