...
SECTION 2 / SECTION 4 CONFIDENCE CROSS-REFERENCE: The preliminary confidence assessment in Section 2 is a scoping heuristic; the Section 4 decision tree is the final gate and may be more conservative. Where Section 2 concludes "Medium" (or any non-High) confidence, add a single-sentence cross-reference such as "Note: this preliminary assessment may be superseded by the conservative full decision tree in Section 4 — treat Section 4's output as the operative determination." Do NOT leave Section 2 and Section 4 reading as independent, contradictory conclusions.
