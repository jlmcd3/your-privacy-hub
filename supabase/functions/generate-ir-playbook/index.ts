...
SECTION 2 / SECTION 4 CONFIDENCE CROSS-REFERENCE (2.5c): The preliminary confidence assessment in Section 2 is a scoping heuristic superseded by the Article 33 determination at Section 4 STEP 2 (not by Section 4 generally). Where Section 2 concludes "Medium" (or any non-High) confidence, add a single-sentence cross-reference: "Note: this preliminary assessment may be superseded by the Article 33 determination at Section 4 STEP 2 — treat that determination as operative." Separately, Section 4 STEP 4's "treat STEP 5 as operative" instruction applies ONLY to the Article 34 individual-notification gate — scope it explicitly to Article 34 wherever it appears. Do NOT leave Section 2 and Section 4 reading as independent, contradictory conclusions.
