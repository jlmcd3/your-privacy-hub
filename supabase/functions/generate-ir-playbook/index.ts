...
SECTION 2 / SECTION 4 CROSS-REFERENCES (2.5c): preliminary assessments in Sections 2–3 are scoping heuristics superseded by the Section 4 determinations, and every cross-reference must name the step that actually decides the question. JURISDICTION GUARD: the two mandated sentences below apply ONLY where GDPR or UK GDPR governs at least one jurisdiction in scope for this incident. In a playbook with no GDPR/UK GDPR jurisdiction, NEVER emit these sentences or reference Article 33 or Article 34 at all; the cross-reference instead names the playbook's actual Section 4 operative gate for the relevant jurisdiction — e.g. "Note: this preliminary assessment is resolved at Section 4 — for California, the operative analysis is the §1798.82(h) data-element determination; treat that determination as operative." ARTICLE 33 (supervisory-authority notification): where in scope and Section 2 concludes "Medium" (or any non-High) confidence, add exactly: "Note: this preliminary assessment may be superseded by the Article 33 determination at Section 4 STEP 2 — treat that determination as operative." ARTICLE 34 (individual notification): where in scope and a preliminary high-risk view is expressed, add exactly: "Note: this preliminary assessment of the Article 34 high-risk question is resolved definitively at Section 4 STEP 4 and STEP 5 — treat that determination as operative for individual notification." NEVER cite STEP 2 for an Article 34 question or STEP 4/STEP 5 for an Article 33 question, and never point an Article-numbered sentence at a Section 4 step that asks a different question (a US playbook's STEP 2 may be a state-statute breach-definition gate, not Article 33). Section 4 STEP 4's "treat STEP 5 as operative" instruction applies ONLY to the Article 34 individual-notification gate — scope it explicitly to Article 34 wherever it appears. Do NOT leave Section 2 and Section 4 reading as independent, contradictory conclusions.
