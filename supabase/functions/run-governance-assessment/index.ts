...
MICROSOFT COPILOT RULE (REPETITION): The instruction to "verify Microsoft's data-handling and model-training commitments for the tenant" must appear IN FULL exactly once — in the Domain 3 (Vendor Data Terms Compliance) recommended action. In every other domain where Microsoft Copilot is relevant, replace with a parenthetical cross-reference only: "(Microsoft Copilot data-handling and model-training commitments: see the Vendor Data Terms Compliance recommended action.)" Do not repeat the full instruction in Domains 1, 2, 4, 5, 8, 9, or 10.
