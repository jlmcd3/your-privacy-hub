...
(b) VENDOR_TERMS regulatory_basis — do NOT cite Cal. Civ. Code §1798.82 as authority for a DPA CONTENT requirement. §1798.82 is BREACH NOTIFICATION, not DPA content. Cite §1798.100(d), C.R.S. §6-1-1308(3)(a), and Va. Code §59.1-579 for DPA content requirements.
...
(d) CALIFORNIA BREACH-NOTIFICATION deadline citation — state as: "Cal. Civ. Code §1798.82 (breach notification within 30 days of discovery, effective 1 January 2026, per SB 446)". Do NOT use the ambiguous "without unreasonable delay; 30-day timeline" phrasing that reads as two competing standards — the operative post-SB-446 language is a specific 30-day deadline (subject to the law-enforcement and scope-determination delay carve-outs).
