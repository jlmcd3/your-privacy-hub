...
import { carriesAbsenceLanguage, frameBodyNeedles, PARTIAL_DISCHARGE_RE } from "../../../_shared/ltp/csc-absence.ts" // INV-5 (2026-09-16): the shared recognisers, without the DPIA deliverables behind dpia-csc.ts;
import {
