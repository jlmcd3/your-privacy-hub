...
export const BUILD_STAMP = "cyber-cppa-hf5@2026-07-20T00:00Z";
...
Every insufficient-basis or "Insufficient information" finding elsewhere in this output (including any per-control status of "Insufficient information") MUST have a corresponding information_needed entry; otherwise return an empty array.`;
    ...
    (report as any)._meta = { ...((report as any)._meta ?? {}), prompt_version: stampPromptVersion("cppa-cybersecurity", "cyber-cppa-hf4@2026-07-19"), build_stamp: BUILD_STAMP };
    ...
    try { const _prose = extractProseFromReport(report); const _det = [...runFormatChecksGeneric(_prose), ...runCppaHf1Checks(_prose)].map(x=>({...x, check_type:'deterministic' as const})); attachDeterministicChecks(report as any, _det as any); } catch(_) {}
