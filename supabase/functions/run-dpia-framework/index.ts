...
export const DPIA_TOOL_MODULE: ToolModule = {
  ...
  citationFramework:
    "Cite well-established GDPR article numbers only (e.g. Article 35, Article 32); do not invent sub-article/paragraph numbers unless explicitly described in the processing context. DPIA guidance = 'EDPB (endorsed) Guidelines on DPIA (WP248 rev.01)' — never 'EDPB Guidelines 09/2022' (that is breach notification). SUPERVISORY AUTHORITY, LEAD AUTHORITY, OSS, TRANSFER MECHANISMS, and ADEQUACY DECISIONS: use ONLY the names and citations in the RESOLVED JURISDICTION block provided below — never name a supervisory authority, transfer instrument, or adequacy decision from your own knowledge. (For German private-sector controllers the competent authority is the Land authority, never the BfDI; the resolved block carries the correct one.)",
