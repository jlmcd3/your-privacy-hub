...
const ADEQUACY_EU: Record<string, TransferMechanism> = {
  ...
  UK: { id: "EU-UK-adequacy", mechanism: "Adequacy decision (United Kingdom)", citation: "Commission Implementing Decision (EU) 2021/1772; sunset extension under review — verify current instrument before relying on it", tiaRequired: false, verifyAgainst: "https://eur-lex.europa.eu/eli/dec_impl/2021/1772/oj", lastVerified: "2026-06-01" },
