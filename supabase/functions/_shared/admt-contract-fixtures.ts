...
export const FIXTURE_ADMT_YIELD_K1: AdmtContractFixture = {
  ...
  intake: {
    ...
    human_review: "Yes — recruiter reviews before adverse decision",
    training_data_use: "Historical applicant + hire outcomes (last 5 years)",
    profiling_use: "Yes — candidate ranking based on resume signals",
    admt_system_count: "1",
    third_party_admt: "No",
    notice_delivery: ["Application website"],
    ...
    opt_out_exception: "Human involvement — recruiter review before rejection",
