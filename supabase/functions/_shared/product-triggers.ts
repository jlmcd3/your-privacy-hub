...
export const PRODUCT_DISPLAY: Record<string, { name: string; route: string }> = {
  ...
  "lia": { name: "Legitimate Interests Assessment", route: "/li-assessment" },
  "ir-playbook": { name: "Incident Response Playbook", route: "/ir-playbook" },
  "biometric-checker": { name: "Biometric Compliance Assessment", route: "/biometric-checker" },
  "dpa-generator": { name: "Custom DPA", route: "/dpa-generator" },
