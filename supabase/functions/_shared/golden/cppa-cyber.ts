...
const meridian: Record<string, CtrlSpec> = {
  ...
  c13_training: { notes: "Annual security & privacy training via LearnUpon (95% completion within 30 days of hire); role-based secure-coding module for engineers (78% completion — gap in EMEA cohort tracked as TRN-441).", maturity: "Partial" },
  c14_secure_dev: { notes: "SAST (Semgrep) and SCA (Snyk) enforced in CI with break-build on critical; threat modelling on major features using STRIDE; secrets scanning (GitGuardian) since 2026-04; no formal DAST program yet.", maturity: "Partial" },
