...
export const SR_PRODUCTS: ReadonlySet<string> = new Set<string>([
  ...
  "registration",
  "ir-playbook",
  // DOC 178 (2026-09-04) — RoPA is the ninth and final product; it renders
  // its own standalone HTML (never through this file's shared renderer, so
  // isSyllabusRecordProduct() is never actually called for it) but is
  // listed here for completeness as a Syllabus & Record product.
  "ropa",
]);
