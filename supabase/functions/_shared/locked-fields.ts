...
export const LOCKED_FIELDS_MAP: Record<string, string[]> = {
  ...
  dpa_generator:         ["entity_name", "controller_name", "processor_name", "controller_jurisdiction", "processor_jurisdiction", "doc_type"],
  ir_playbook:           ["organization_name", "jurisdictions"],
