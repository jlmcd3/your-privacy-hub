  ...
  return [
    ...
    },
    {
      ...
      clauses: [
        ...
        `2.6 "DPA" means this Data Processing Agreement.`,
      ],
    },
    {
      ...
      clauses: [
        ...
        `3.2 The Processor shall process Personal Data solely for the specific business purposes of providing the Services described in Annex B, and for no other purpose. The Services shall be described specifically in Annex B; a reference to the Principal Agreement alone shall not constitute that description.`,
    ...
    },
    {
      ...
      clauses: [
        ...
        `7.2 (Breach notification.) The Processor shall notify the Controller of a Personal Data Breach affecting Personal Data processed on the Controller's behalf without undue delay after becoming aware of it, and in any event within [48] hours, providing the information then reasonably available to the Processor that the Controller needs to satisfy its notification obligations and supplementing it in phases without undue further delay as further information becomes available. The notification shall describe the nature of the breach, the categories and approximate number of individuals and records concerned, the likely consequences, and the measures taken or proposed to address the breach and mitigate its possible adverse effects.`,
