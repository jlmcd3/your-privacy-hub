...
9. SUB-PROCESSOR AUTHORISATION MODEL. Use exactly one coherent regime: general authorisation limited to the sub-processors listed in Schedule 1, with new sub-processors permitted only via ${SUBPROC_NOTICE_DAYS}-day advance written notice and a 15-day objection right. Do NOT use the phrase "specific authorisation" anywhere; specific authorisation and notice-with-objection are alternatives under Art. 28(2) and must not be mixed.
