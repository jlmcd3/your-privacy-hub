...
Review with qualified counsel before publishing.</footer>` : ""}
</body>
</html>`;
}
...
${states
  ...
  .join("\n")}
<footer>Generated by EndUserPrivacy.com. This combined suite is a starting template based on your inputs and is not legal advice. Review with qualified counsel before publishing.</footer>
</body></html>`;
