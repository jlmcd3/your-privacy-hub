...
This notice is a starting template based on your inputs and is not legal advice.
Confirm the recorded facts (business identity, categories collected, purposes, and applicable state) before publishing.</footer>` : ""}
</body>
</html>`;
}
...
This notice is a starting template based on your inputs and is not legal advice.
Confirm the recorded facts (business identity, categories collected, purposes, and applicable states) before publishing.</footer>
</body></html>`;
