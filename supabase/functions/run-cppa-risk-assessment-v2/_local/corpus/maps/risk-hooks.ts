// CPPA-RISK ANALOGY HOOKS — pinned, generated file (doc 213 / doc 222).
//
...
export const RISK_HOOKS: readonly AuthorityHook[] = [
  ...
  },
  {
    ...
    "fact_atoms": [
      "flag:sensitive_pi",
      "state:intake.processing_status=Planned"
    ],
    "distinguishing_atoms": [],
    "not_distinguishable": false,
    "required_atoms": [
    ...
    "finding_span": "ICS heeft nagelaten om een DPIA uit te voeren voordat het bedrijf in 2019 begon met het digitaal identificeren van klanten in Nederland",
    "fact_pattern_paraphrase": "a business rolling out a new identity-verification process, collecting a photo from about 1.5 million customers and comparing it against their ID documents, without assessing the risk first",
    "finding_paraphrase": "failing to carry out a DPIA before the company began digitally identifying customers breached the obligation to assess the risk before that processing started",
    "settledness": "R3",
    "posture": "rejected",
    "factor_id": "Assessment timing and material changes",
    "bears_on_element": "Assessment timing and material changes",
    "authority_label": "Autoriteit Persoonsgegevens (Dutch Data Protection Authority), International Card Services B.V., decision of 15 January 2024, final on appeal",
    "regulator": "AP",
    "relevance": {
      "instrument": "GDPR",
      "factor_ids": [
    ...
    "authority_label_short": "AP, International Card Services B.V.",
    "hook_version": 1,
    ...
    "pinpoint": {
      "kind": "field",
      "ref": "source_document_text",
      "anchor_span": "ICS heeft nagelaten om een DPIA uit te voeren voordat het bedrijf in 2019 begon met het digitaal identificeren van klanten in Nederland"
    },
    "recognised_proposition": null,
    "condition_text": null,
    "condition_atoms": null,
