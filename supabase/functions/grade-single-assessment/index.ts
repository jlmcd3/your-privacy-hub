...
const RUBRIC_GENERAL: RubricCheck[] = [
  ...
  { id: "rubric_citation_misapplied",       dimension: "citation",      severity: "high",
    description: "A real cited section is applied to the wrong proposition (right citation, wrong claim). DOC 245 (2026-09-09): this check requires a cited provision IN the quoted passage. A conclusion sentence that applies the test stated in its section's Governing Requirement box without itself citing anything cannot misapply a citation; an objection to the legal reasoning of such a sentence names the specific error under accuracy, never under this check." },
];
