...
const REGISTRY_SNAPSHOT: RegistryEntry[] = [
  ...
  { lookupKey: "li_subscriber_v2",        productKey: "lia_v8",        productName: "Legitimate Interest Assessment (Subscriber alias)",     description: "Subscriber-rate alias (mirrors standalone — no longer discounted) for the LIA Tool.",                                        amountCents: 2800,  currency: "usd", kind: "addon",    active: true },
  ...
  { lookupKey: "dpia_subscriber_v2",      productKey: "dpia_v8",       productName: "Impact Assessment Builder (Subscriber alias)",          description: "Subscriber-rate alias (mirrors standalone — no longer discounted) for the DPIA Tool.",                                       amountCents: 3600,  currency: "usd", kind: "addon",    active: true },
  ...
  { lookupKey: "dpa_subscriber_v2",       productKey: "dpa_v8",        productName: "Custom DPA Generator (Subscriber alias)",               description: "Subscriber-rate alias (mirrors standalone — no longer discounted) for the DPA Generator.",                                   amountCents: 3600,  currency: "usd", kind: "addon",    active: true },
  ...
  { lookupKey: "ir_subscriber_v2",        productKey: "ir_v8",         productName: "Breach Response Playbook (Subscriber alias)",           description: "Subscriber-rate alias (mirrors standalone — no longer discounted) for the Breach Response Playbook.",                   amountCents: 2125,  currency: "usd", kind: "addon",    active: true },
  ...
  { lookupKey: "biometric_subscriber_v2", productKey: "biometric_v8",  productName: "Biometric Compliance Check (Subscriber alias)",         description: "Subscriber-rate alias (mirrors standalone — no longer discounted) for the Biometric Compliance Check.",                      amountCents: 1200,  currency: "usd", kind: "addon",    active: true },
  ...
  { lookupKey: "ropa_initial_subscriber", productKey: "rofa",          productName: "RoPA Builder — Initial (Subscriber alias)",             description: "Subscriber-rate alias (mirrors standalone — no longer discounted) for RoPA initial generation.",                       amountCents: 3400,  currency: "usd", kind: "addon",    active: true },
  ...
  { lookupKey: "ropa_refresh_subscriber", productKey: "rofa",          productName: "RoPA Builder — Annual Refresh (Subscriber alias)",      description: "Subscriber-rate alias (mirrors standalone — no longer discounted) for RoPA annual refresh.",                           amountCents: 3400,  currency: "usd", kind: "addon",    active: true },
  ...
  { lookupKey: "us_notice_v7_subscriber", productKey: "us_notice_v8",  productName: "US Privacy Notice Builder (Subscriber alias)",          description: "Subscriber-rate alias (mirrors standalone — no longer discounted) for any US notice variant.",                         amountCents: 2125,  currency: "usd", kind: "addon",    active: true },
  ...
  { lookupKey: "eu_notice_v7_subscriber", productKey: "eu_notice_v8",  productName: "EU & Global Privacy Notice Builder (Subscriber alias)", description: "Subscriber-rate alias (mirrors standalone — no longer discounted) for any EU/global notice variant.",                   amountCents: 4300,  currency: "usd", kind: "addon",    active: true },
  ...
  { lookupKey: "cppa_risk_subscriber",    productKey: "cppa_risk",     productName: "CPPA Risk Assessment — Module 1 (Subscriber alias)",    description: "Subscriber-rate alias (mirrors standalone — no longer discounted) for the CPPA Risk Assessment.",                            amountCents: 4400,  currency: "usd", kind: "addon",    active: true },
  ...
  { lookupKey: "cppa_cyber_subscriber",   productKey: "cppa_cyber",    productName: "CPPA Cybersecurity Readiness — Module 2 (Subscriber alias)", description: "Subscriber-rate alias (mirrors standalone — no longer discounted) for the CPPA Cybersecurity Readiness assessment.",      amountCents: 5600,  currency: "usd", kind: "addon",    active: true },
  ...
  { lookupKey: "cppa_suite_subscriber",   productKey: "cppa_suite",    productName: "CPPA Full Audit Suite — Modules 1 & 2 (Subscriber alias)", description: "Subscriber-rate alias (mirrors standalone — no longer discounted) for the CPPA Full Audit Suite.",                        amountCents: 10000, currency: "usd", kind: "addon",    active: true },
  ...
  { lookupKey: "registration_subscriber", productKey: "registration",  productName: "Registration Filings — DIY Toolkit (Subscriber alias)", description: "Subscriber-rate alias (mirrors standalone — no longer discounted) for the DPO / DPA / AI Act registration document pack.",     amountCents: 3800, currency: "usd", kind: "addon",    active: true },
];
