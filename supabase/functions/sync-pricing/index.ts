...
const REGISTRY_SNAPSHOT: RegistryEntry[] = [
  ...
  { lookupKey: "cppa_admt_standalone",    productKey: "cppa_admt",         productName: "ADMT Compliance Assessment — Module 3 (Standalone)",     description: "Standalone per-use price for the ADMT Compliance Assessment (pre-use notice, opt-out, access rights gap analysis).", amountCents: 9900, currency: "usd", kind: "one_time", active: true },
  { lookupKey: "cppa_admt_subscriber",    productKey: "cppa_admt",         productName: "ADMT Compliance Assessment — Module 3 (Subscriber)",     description: "Subscriber per-use price for the ADMT Compliance Assessment.", amountCents: 4900, currency: "usd", kind: "addon",    active: true },
  ...
  { lookupKey: "li_topup_v1",                 productKey: "lia_v8",             productName: "Legitimate Interest Assessment — 4 additional generations",  description: "Meter top-up: adds 4 additional generations on an existing LIA. Half-price policy.",                                 amountCents: 4950,  currency: "usd", kind: "addon", active: true },
  ...
  { lookupKey: "dpia_topup_v1",               productKey: "dpia_v8",            productName: "Impact Assessment Builder — 4 additional generations",       description: "Meter top-up: adds 4 additional generations on an existing DPIA. Half-price policy.",                                amountCents: 4950,  currency: "usd", kind: "addon", active: true },
  ...
  { lookupKey: "cppa_admt_topup_v1",          productKey: "cppa_admt",          productName: "ADMT Compliance Assessment — 4 additional generations",      description: "Meter top-up: adds 4 additional generations on an existing ADMT Compliance Assessment. Half-price policy.",          amountCents: 4950,  currency: "usd", kind: "addon", active: true },
  { lookupKey: "cppa_risk_topup_v1",          productKey: "cppa_risk",          productName: "CPPA Risk Assessment — 4 additional generations",            description: "Meter top-up: adds 4 additional generations on an existing CPPA Risk Assessment. Half-price policy.",                amountCents: 11450, currency: "usd", kind: "addon", active: true },
