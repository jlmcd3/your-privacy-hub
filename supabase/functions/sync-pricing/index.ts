...
const REGISTRY_SNAPSHOT: RegistryEntry[] = [
  ...
  { lookupKey: "hc_subscriber_v2",        productKey: "governance_v8", productName: "Privacy Program Assessment (Subscriber)",                description: "Subscriber per-use price for the Privacy Program Assessment Tool.",                                       amountCents: 2500,  currency: "usd", kind: "addon",    active: true },
  ...
  { lookupKey: "ir_standalone_v2",        productKey: "ir_v8",         productName: "Breach Response Playbook (Standalone)",                    description: "Standalone per-use price for the Breach Response Playbook.",                                              amountCents: 5900,  currency: "usd", kind: "one_time", active: true },
  ...
  { lookupKey: "ir_subscriber_v2",        productKey: "ir_v8",         productName: "Breach Response Playbook (Subscriber)",                  description: "Free for subscribers — bypasses Stripe checkout.",                                                        amountCents: 0,     currency: "usd", kind: "addon",    active: false },
  ...
  { lookupKey: "cppa_risk_subscriber",    productKey: "cppa_risk",     productName: "CPPA Risk Assessment — Module 1 (Subscriber)",          description: "Subscriber per-use price for the CPPA Risk Assessment.",                                                  amountCents: 7900,  currency: "usd", kind: "addon",    active: true },
  ...
  { lookupKey: "cppa_cyber_subscriber",   productKey: "cppa_cyber",    productName: "CPPA Cybersecurity Readiness — Module 2 (Subscriber)",   description: "Subscriber per-use price for the CPPA Cybersecurity Readiness assessment.",                               amountCents: 9900,  currency: "usd", kind: "addon",    active: true },
  { lookupKey: "cppa_suite_standalone",   productKey: "cppa_suite",    productName: "CPPA Full Audit Suite — Modules 1 & 2 (Standalone)",       description: "Complete CPPA audit readiness bundle.",                                                                   amountCents: 29900, currency: "usd", kind: "one_time", active: true },
  { lookupKey: "cppa_suite_subscriber",   productKey: "cppa_suite",    productName: "CPPA Full Audit Suite — Modules 1 & 2 (Subscriber)",     description: "Subscriber per-use price for the CPPA Full Audit Suite.",                                                 amountCents: 14900, currency: "usd", kind: "addon",    active: true },
