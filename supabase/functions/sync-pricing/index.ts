...
const REGISTRY_SNAPSHOT: RegistryEntry[] = [
  ...
  { lookupKey: "eu_notice_v7_subscriber", productKey: "eu_notice_v8",  productName: "EU & Global Privacy Notice Builder (Founding Subscriber)", description: "Founding subscriber rate (15% off Convenience Tools) for any EU/global notice variant.",                   amountCents: 4300,  currency: "usd", kind: "addon",    active: true },
