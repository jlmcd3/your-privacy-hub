...
const REGISTRY_SNAPSHOT: RegistryEntry[] = [
  ...
  { lookupKey: "hc_subscriber_v2",        productKey: "governance_v8", productName: "Privacy Program Assessment (Founding Subscriber)",         description: "Founding subscriber rate (20% off Smart Tools) for the Privacy Program Assessment Tool.",                  amountCents: 4400,  currency: "usd", kind: "addon",    active: true },
  ...
  { lookupKey: "li_subscriber_v2",        productKey: "lia_v8",        productName: "Legitimate Interest Assessment (Founding Subscriber)",     description: "Founding subscriber rate (20% off Smart Tools) for the LIA Tool.",                                        amountCents: 2800,  currency: "usd", kind: "addon",    active: true },
  ...
  { lookupKey: "dpia_subscriber_v2",      productKey: "dpia_v8",       productName: "Impact Assessment Builder (Founding Subscriber)",          description: "Founding subscriber rate (20% off Smart Tools) for the DPIA Tool.",                                       amountCents: 3600,  currency: "usd", kind: "addon",    active: true },
  ...
  { lookupKey: "dpa_subscriber_v2",       productKey: "dpa_v8",        productName: "Custom DPA Generator (Founding Subscriber)",               description: "Founding subscriber rate (20% off Smart Tools) for the DPA Generator.",                                   amountCents: 3600,  currency: "usd", kind: "addon",    active: true },
  ...
  { lookupKey: "ir_subscriber_v2",        productKey: "ir_v8",         productName: "Breach Response Playbook (Founding Subscriber)",           description: "Founding subscriber rate (15% off Convenience Tools) for the Breach Response Playbook.",                   amountCents: 2125,  currency: "usd", kind: "addon",    active: true },
  ...
  { lookupKey: "biometric_subscriber_v2", productKey: "biometric_v8",  productName: "Biometric Compliance Check (Founding Subscriber)",         description: "Founding subscriber rate (20% off Smart Tools) for the Biometric Compliance Check.",                      amountCents: 1200,  currency: "usd", kind: "addon",    active: true },
  ...
  { lookupKey: "ropa_initial_subscriber", productKey: "rofa",          productName: "RoPA Builder — Initial (Founding Subscriber)",             description: "Founding subscriber rate (15% off Convenience Tools) for RoPA initial generation.",                       amountCents: 3400,  currency: "usd", kind: "addon",    active: true },
  ...
  { lookupKey: "ropa_refresh_subscriber", productKey: "rofa",          productName: "RoPA Builder — Annual Refresh (Founding Subscriber)",      description: "Founding subscriber rate (15% off Convenience Tools) for RoPA annual refresh.",                           amountCents: 3400,  currency: "usd", kind: "addon",    active: true },
  ...
  { lookupKey: "us_notice_v7_subscriber", productKey: "us_notice_v8",  productName: "US Privacy Notice Builder (Founding Subscriber)",          description: "Founding subscriber rate (15% off Convenience Tools) for any US notice variant.",                         amountCents: 2125,  currency: "usd", kind: "addon",    active: true },
  ...
  { lookupKey: "eu_notice_v7_subscriber", productKey: "eu_notice_v8",  productName: "EU & Global Privacy Notice Builder (Founding Subscriber)", description: "Founding subscriber rate (15% off Convenience Tools) for any EU/global notice variant.",                   amountCents: 4250,  currency: "usd", kind: "addon",    active: true },
  ...
  { lookupKey: "cppa_risk_subscriber",    productKey: "cppa_risk",     productName: "CPPA Risk Assessment — Module 1 (Founding Subscriber)",    description: "Founding subscriber rate (20% off Smart Tools) for the CPPA Risk Assessment.",                            amountCents: 4400,  currency: "usd", kind: "addon",    active: true },
