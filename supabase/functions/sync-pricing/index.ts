...
const REGISTRY_SNAPSHOT: RegistryEntry[] = [
  ...
  { lookupKey: "hc_subscriber_v2",        productKey: "governance_v8", productName: "Privacy Program Assessment (Subscriber alias)",         description: "Subscriber-rate alias (mirrors standalone — no longer discounted) for the Privacy Program Assessment Tool.",                  amountCents: 8900,  currency: "usd", kind: "addon",    active: true },
  ...
  { lookupKey: "li_subscriber_v2",        productKey: "lia_v8",        productName: "Legitimate Interest Assessment (Subscriber alias)",     description: "Subscriber-rate alias (mirrors standalone — no longer discounted) for the LIA Tool.",                                        amountCents: 6900,  currency: "usd", kind: "addon",    active: true },
  ...
  { lookupKey: "dpia_subscriber_v2",      productKey: "dpia_v8",       productName: "Impact Assessment Builder (Subscriber alias)",          description: "Subscriber-rate alias (mirrors standalone — no longer discounted) for the DPIA Tool.",                                       amountCents: 7900,  currency: "usd", kind: "addon",    active: true },
  ...
  { lookupKey: "dpa_subscriber_v2",       productKey: "dpa_v8",        productName: "Custom DPA Generator (Subscriber alias)",               description: "Subscriber-rate alias (mirrors standalone — no longer discounted) for the DPA Generator.",                                   amountCents: 4900,  currency: "usd", kind: "addon",    active: true },
  { lookupKey: "ir_standalone_v2",        productKey: "ir_v8",         productName: "Breach Response Playbook (Standalone)",                    description: "Standalone per-use price for the Breach Response Playbook.",                                              amountCents: 3000,  currency: "usd", kind: "one_time", active: true },
  { lookupKey: "ir_subscriber_v2",        productKey: "ir_v8",         productName: "Breach Response Playbook (Subscriber alias)",           description: "Subscriber-rate alias (mirrors standalone — no longer discounted) for the Breach Response Playbook.",                   amountCents: 3000,  currency: "usd", kind: "addon",    active: true },
  { lookupKey: "biometric_standalone_v2", productKey: "biometric_v8",  productName: "Biometric Compliance Check (Standalone)",                  description: "Standalone per-use price for the Biometric Compliance Check.",                                            amountCents: 3500,  currency: "usd", kind: "one_time", active: true },
  { lookupKey: "biometric_subscriber_v2", productKey: "biometric_v8",  productName: "Biometric Compliance Check (Subscriber alias)",         description: "Subscriber-rate alias (mirrors standalone — no longer discounted) for the Biometric Compliance Check.",                      amountCents: 3500,  currency: "usd", kind: "addon",    active: true },
  ...
  { lookupKey: "eu_notice_v7_subscriber", productKey: "eu_notice_v8",  productName: "EU & Global Privacy Notice Builder (Subscriber alias)", description: "Subscriber-rate alias (mirrors standalone — no longer discounted) for any EU/global notice variant.",                   amountCents: 4000,  currency: "usd", kind: "addon",    active: true },
  { lookupKey: "cppa_risk_standalone",    productKey: "cppa_risk",     productName: "CPPA Risk Assessment — Module 1 (Standalone)",             description: "Standalone per-use price for the CPPA Risk Assessment.",                                                  amountCents: 8900,  currency: "usd", kind: "one_time", active: true },
  { lookupKey: "cppa_risk_subscriber",    productKey: "cppa_risk",     productName: "CPPA Risk Assessment — Module 1 (Subscriber alias)",    description: "Subscriber-rate alias (mirrors standalone — no longer discounted) for the CPPA Risk Assessment.",                            amountCents: 8900,  currency: "usd", kind: "addon",    active: true },
  { lookupKey: "cppa_cyber_standalone",   productKey: "cppa_cyber",    productName: "CPPA Cybersecurity Readiness — Module 2 (Standalone)",     description: "Standalone per-use price for the CPPA Cybersecurity Readiness assessment.",                               amountCents: 9900,  currency: "usd", kind: "one_time", active: true },
  { lookupKey: "cppa_cyber_subscriber",   productKey: "cppa_cyber",    productName: "CPPA Cybersecurity Readiness — Module 2 (Subscriber alias)", description: "Subscriber-rate alias (mirrors standalone — no longer discounted) for the CPPA Cybersecurity Readiness assessment.",      amountCents: 9900,  currency: "usd", kind: "addon",    active: true },
  { lookupKey: "cppa_suite_standalone",   productKey: "cppa_suite",    productName: "CPPA Full Audit Suite — Modules 1 & 2 (Standalone)",       description: "Complete CPPA audit readiness bundle.",                                                                   amountCents: 15900, currency: "usd", kind: "one_time", active: true },
  { lookupKey: "cppa_suite_subscriber",   productKey: "cppa_suite",    productName: "CPPA Full Audit Suite — Modules 1 & 2 (Subscriber alias)", description: "Subscriber-rate alias (mirrors standalone — no longer discounted) for the CPPA Full Audit Suite.",                        amountCents: 15900, currency: "usd", kind: "addon",    active: true },
