...
//
// Product: lia
// Factor vocabulary: LIA_FACTOR_VOCABULARY (lia-corpus-map.ts)
// Profiles version: lia-relevance-profiles-v1-2026-09-07
//
...
// equivalent) may import LIA_RULE_PROFILES only. Importing
// LIA_PATTERN_PROFILES from such a file fails
...
//
// Every profile in LIA_RULE_PROFILES has been ratified by the CEO or a
...
export const LIA_PROFILES_VERSION = "lia-relevance-profiles-v1-2026-09-07";

export const LIA_RULE_PROFILES: Readonly<Record<string, AuthorityRelevanceProfile>> = {};

export const LIA_PATTERN_PROFILES: Readonly<Record<string, AuthorityRelevanceProfile>> = {
  "lia/f04-balancing/ap-01": {
    product: "lia",
    country: "IE",
    instrument: "EU GDPR",
    factor_ids: ["Balancing of interests, rights and freedoms", "Interest legitimacy", "Reasonable expectations of the data subject"],
    ...
    curation_note: "Doc 63 §6.1 item 1 (ratified 2026-08-23): DPC (Ireland), LinkedIn, decision of 22 October 2024. What happened: \"Ireland's Data Protection Commission fined LinkedIn €310,000,000 for processing personal data for behavioural analysis and targeted advertising without a valid legal basis, with insufficient transparency.\" Bearing (this factor): \"The largest verified rejection of legitimate-interests reliance: where balancing fails, the basis fails — the exact test this assessment performs.\" authority_label: \"DPC (Ireland), LinkedIn, decision of 22 October 2024 — persuasive authority\" (docket rule: the row's free-text reference is non-docket-shaped, omitted). trail_cite: \"DPC, LinkedIn (2024)\". Re-verified live 2026-08-25 against enforcement_actions: fine_eur_equivalent, decision_date, regulator, jurisdiction all match. Sibling row: lia/f01-interest-legitimacy/ap-01 (same source, Interest-legitimacy tag). Banked per doc 48 §II.6 — flips render_eligible:true + adds the display block above at L1.\n\nDoc 63 §6.1 item 1's Interest-legitimacy tag (same source and ratified bytes as lia/f04-balancing/ap-01 — one curation, two factors, doc 48 III.2). DPC (Ireland), LinkedIn, decision of 22 October 2024, €310,000,000: a processing basis fails on interest legitimacy before balancing is even reached whenever the asserted interest itself cannot be named or is not the controller's own to pursue. Banked per doc 48 §II.6. | classify r2: stage3: both framings independently identified a categorical legal proposition and both quotes verified as real substrings — rule candidate | 2026-09-07 orchestrator review of r2 promotions: DEMOTED to pattern — the text states a rule, but not a rule on Article 6(1)(f) reliance usable in the LIA decision tree (doc 206D); rule_statement kept for reference",
    pipeline_stage: "stage3_consistency",
    extracted_quote: "The lawfulness of processing is a fundamental aspect of data protection law and the processing of personal data without an appropriate legal basis is a clear and serious violation of a data subject's fundamental right to data protection .",
    quote_verified: true,
    self_consistency_agreement: true,
    confidence_tier: "high",
    pipeline_version: "corpus-classify-v1-2026-09-06",
    classified_at: "2026-09-07T01:16:01.422+00:00",
  },
  "lia/f01-interest-legitimacy/ap-01": {
    product: "lia",
    country: "IE",
    instrument: "EU GDPR",
    factor_ids: ["Balancing of interests, rights and freedoms", "Interest legitimacy", "Reasonable expectations of the data subject"],
  ...
  "lia/f03-necessity/ap-01": {
    ...
    confidence_tier: "high",
    pipeline_version: "corpus-classify-v1-2026-09-06",
    classified_at: "2026-09-07T01:24:01.588+00:00",
  },
  "lia/f11-eprivacy/ap-01": {
    product: "lia",
    country: "FR",
    instrument: "EU GDPR",
    factor_ids: ["Necessity and less-intrusive means", "Special-category and ePrivacy interplay"],
  ...
  "lia/f01-interest-legitimacy/ap-02": {
    ...
    country: "ES",
    instrument: "EU GDPR",
    factor_ids: ["Interest legitimacy", "Third-party interests", "Necessity and less-intrusive means"],
    use_case_class: null,
    outcome_posture: "rejected",
    relationship: "public",
    data_categories: ["Health or medical data", "Special category data"],
    ...
    confidence_tier: "high",
    pipeline_version: "corpus-classify-v1-2026-09-06",
    classified_at: "2026-09-07T02:36:01.154+00:00",
  },
  "lia/f02-third-party-interests/ap-01": {
    product: "lia",
    country: "ES",
    instrument: "EU GDPR",
    factor_ids: ["Interest legitimacy", "Third-party interests", "Necessity and less-intrusive means"],
  ...
  "lia/f05-reasonable-expectations/ap-01": {
    ...
    country: "ES",
    instrument: "EU GDPR",
    factor_ids: ["Reasonable expectations of the data subject", "Potential harms and severity", "Relationship with the individual"],
    use_case_class: null,
    outcome_posture: "rejected",
    relationship: "public",
    ...
    confidence_tier: "high",
    pipeline_version: "corpus-classify-v1-2026-09-06",
    classified_at: "2026-09-07T01:40:01.394+00:00",
  },
  "lia/f07-harms/ap-01": {
    product: "lia",
    country: "ES",
  ...
  "lia/f06-relationship/ap-01": {
    product: "lia",
    country: "FR",
    instrument: "EU GDPR",
    factor_ids: ["Relationship with the individual", "Potential harms and severity", "Necessity and less-intrusive means", "Balancing of interests, rights and freedoms"],
    ...
    confidence_tier: "high",
    pipeline_version: "corpus-classify-v1-2026-09-06",
    classified_at: "2026-09-07T02:18:01.29+00:00",
  },
  "lia/f07-harms/ap-02": {
    product: "lia",
    country: "FR",
  ...
  "lia/f05-reasonable-expectations/ap-02": {
    product: "lia",
    country: "FR",
    instrument: "EU GDPR",
    factor_ids: ["Reasonable expectations of the data subject", "Interest legitimacy"],
    ...
    confidence_tier: "high",
    pipeline_version: "corpus-classify-v1-2026-09-06",
    classified_at: "2026-09-07T01:38:01.142+00:00",
  },
  "lia/f01-interest-legitimacy/ap-w5-01": {
    product: "lia",
    country: "IE",
    instrument: "EU GDPR",
    ...
    confidence_tier: "high",
    pipeline_version: "corpus-classify-v1-2026-09-06",
    classified_at: "2026-09-07T01:42:00.963+00:00",
  },
  "lia/f05-expectations/ap-w5-02": {
    product: "lia",
    country: "FR",
    instrument: "EU GDPR",
    factor_ids: ["Reasonable expectations of the data subject", "Interest legitimacy", "Balancing of interests, rights and freedoms"],
    use_case_class: null,
    outcome_posture: "rejected",
    relationship: "public",
    ...
    confidence_tier: "high",
    pipeline_version: "corpus-classify-v1-2026-09-06",
    classified_at: "2026-09-07T02:02:00.981+00:00",
  },
  "lia/f11-eprivacy/ap-w5-03": {
    product: "lia",
    country: "FR",
    instrument: "EU GDPR",
    factor_ids: ["Special-category and ePrivacy interplay", "Interest legitimacy", "Reasonable expectations of the data subject"],
    use_case_class: "behavioral_advertising",
    outcome_posture: "rejected",
    relationship: "public",
    data_categories: ["Browsing/behavioural data", "Device/technical data"],
    ...
    confidence_tier: "high",
    pipeline_version: "corpus-classify-v1-2026-09-06",
    classified_at: "2026-09-07T01:48:02.637+00:00",
  },
  "lia/f07-harms/ap-w5-04": {
    product: "lia",
    country: "ES",
    instrument: "EU GDPR",
    factor_ids: ["Potential harms and severity", "Balancing of interests, rights and freedoms"],
    use_case_class: null,
    outcome_posture: "rejected",
    relationship: "public",
    ...
    confidence_tier: "high",
    pipeline_version: "corpus-classify-v1-2026-09-06",
    classified_at: "2026-09-07T01:54:01.547+00:00",
  },
  "lia/f11-eprivacy/ap-w5-05": {
    product: "lia",
    country: "ES",
    instrument: "EU GDPR",
    factor_ids: ["Special-category and ePrivacy interplay", "Interest legitimacy"],
    use_case_class: null,
    outcome_posture: "rejected",
    relationship: "public",
    ...
    flags: ["special_category"],
    rule_or_pattern: "pattern",
    curation_note: "Doc 73 watch row, wired 2026-09-05 (v5). AEPD (Spain), EUROPA PRESS DE CATALUNYA, S.A., 26 September 2023, EUR 30,000. Source language: English. Bearing (this factor): Article 9 special-category data cannot be reached by Article 6(1)(f) at all - the special-category gate is anterior to the balancing test. NOTE: same underlying facts as the DIARIO ABC row above (two controllers, two decisions, distinct source rows) - both are wired because each is its own verified decision, not a duplicate. DARK pending ratification. | classify r2: stage3: both framings agree the excerpt records an outcome on particular facts — stays pattern | demoted to pattern 2026-09-07: pinned excerpt states the outcome, not the rule; kept as support for doc 206B W4 (ledger B2-19)",
    pipeline_stage: "stage3_consistency",
    extracted_quote: "Article 9 special-category data cannot be reached by Article 6(1)(f) at all - the special-category gate is anterior to the balancing test.",
    quote_verified: false,
    self_consistency_agreement: true,
    confidence_tier: "medium",
    pipeline_version: "corpus-classify-v1-2026-09-06",
    classified_at: "2026-09-07T01:50:02.377+00:00",
  },
  "lia/f03-necessity/ap-w5-06": {
    product: "lia",
    country: "ES",
    instrument: "EU GDPR",
    factor_ids: ["Necessity and less-intrusive means", "Interest legitimacy"],
    use_case_class: null,
    outcome_posture: "rejected",
    relationship: "public",
    ...
    confidence_tier: "high",
    pipeline_version: "corpus-classify-v1-2026-09-06",
    classified_at: "2026-09-07T02:10:01.771+00:00",
  },
  "lia/f05-expectations/ap-w5-07": {
    product: "lia",
    country: "FR",
    instrument: "EU GDPR",
    factor_ids: ["Reasonable expectations of the data subject", "Safeguards and mitigations"],
    use_case_class: "direct_marketing",
    outcome_posture: "rejected",
    relationship: "customer",
    ...
    rule_or_pattern: "pattern",
    curation_note: "Doc 73 watch row, wired 2026-09-05 (v5). CNIL (France), Accor, 3 August 2022, EUR 600,000. Source language: English. Pinned excerpt is a leading clause (the source field continues into an unrelated password-strength finding, excluded deliberately). Bearing (this factor): an unhonoured objection or unsubscribe request is direct evidence that the processing sits outside what the individual expected and accepted. DARK pending ratification. | classify r2: stage1: pattern-prior row holds: no categorical or definitional language — stays at its stage-0 classification",
    pipeline_stage: "stage0_prior",
    extracted_quote: null,
    quote_verified: false,
    self_consistency_agreement: null,
    confidence_tier: "high",
    pipeline_version: "corpus-classify-v1-2026-09-06",
    classified_at: "2026-09-07T01:20:01.114+00:00",
  },
  "lia/f07-harms/ap-w5-08": {
    product: "lia",
    country: "ES",
    instrument: "EU GDPR",
    factor_ids: ["Potential harms and severity", "Balancing of interests, rights and freedoms"],
    ...
    confidence_tier: "high",
    pipeline_version: "corpus-classify-v1-2026-09-06",
    classified_at: "2026-09-07T02:16:00.888+00:00",
  },
  "lia/f01-interest-legitimacy/ap-w5-09": {
    product: "lia",
    country: "ES",
    instrument: "EU GDPR",
    factor_ids: ["Interest legitimacy", "Reasonable expectations of the data subject"],
    use_case_class: "direct_marketing",
    outcome_posture: "rejected",
    relationship: "prospect",
    data_categories: ["Contact data"],
    ...
    confidence_tier: "high",
    pipeline_version: "corpus-classify-v1-2026-09-06",
    classified_at: "2026-09-07T02:00:02.037+00:00",
  },
  "lia/f08-safeguards/ap-w5-10": {
    product: "lia",
    country: "ES",
    instrument: "EU GDPR",
    factor_ids: ["Safeguards and mitigations", "Relationship with the individual"],
    use_case_class: "direct_marketing",
    outcome_posture: "rejected",
    relationship: "prospect",
    data_categories: ["Contact data"],
    ...
    confidence_tier: "high",
    pipeline_version: "corpus-classify-v1-2026-09-06",
    classified_at: "2026-09-07T02:30:02.687+00:00",
  },
  "lia/f04-balancing/ap-w5-11": {
    product: "lia",
    country: "RO",
    instrument: "EU GDPR",
  ...
  "lia/f01-interest-legitimacy/ap-w5-12": {
    product: "lia",
    country: "ES",
    instrument: "EU GDPR",
    factor_ids: ["Interest legitimacy"],
    use_case_class: null,
    outcome_posture: "rejected",
    relationship: null,
    data_categories: ["Contact data"],
    ...
    confidence_tier: "high",
    pipeline_version: "corpus-classify-v1-2026-09-06",
    classified_at: "2026-09-07T02:06:01.646+00:00",
  },
  "lia/f06-relationship/ap-w5-13": {
    product: "lia",
    country: "ES",
    instrument: "EU GDPR",
    factor_ids: ["Relationship with the individual"],
    use_case_class: null,
    outcome_posture: "rejected",
    relationship: null,
    data_categories: ["Contact data"],
  ...
  "lia/f05-expectations/ap-w5-14": {
    product: "lia",
    country: "ES",
    instrument: "EU GDPR",
    factor_ids: ["Reasonable expectations of the data subject", "Relationship with the individual"],
    use_case_class: "direct_marketing",
    outcome_posture: "rejected",
    relationship: "prospect",
    data_categories: ["Contact data"],
    ...
    confidence_tier: "high",
    pipeline_version: "corpus-classify-v1-2026-09-06",
    classified_at: "2026-09-07T01:14:00.953+00:00",
  },
  "lia/f06-relationship/ap-w5-15": {
    product: "lia",
    country: "ES",
    instrument: "EU GDPR",
    factor_ids: ["Relationship with the individual", "Interest legitimacy"],
    use_case_class: null,
    outcome_posture: "rejected",
    relationship: "customer",
    data_categories: ["Contact data"],
    ...
    confidence_tier: "high",
    pipeline_version: "corpus-classify-v1-2026-09-06",
    classified_at: "2026-09-07T01:56:01.763+00:00",
  },
  "lia/f11-eprivacy/ap-w5-16": {
    product: "lia",
    country: "ES",
    instrument: "EU GDPR",
    factor_ids: ["Special-category and ePrivacy interplay", "Interest legitimacy"],
    ...
    flags: ["electronic_marketing"],
    rule_or_pattern: "pattern",
    curation_note: "Doc 73 watch row, wired 2026-09-05 (v5). AEPD (Spain), Venu Sanz Chef, S.L., 30 September 2020, EUR 3,000, PS/00249/2020. SOURCE LANGUAGE: Spanish; pin verbatim and clause-truncated (full field 359 characters, over the pin budget). WORKING ENGLISH TRANSLATION of the pinned clause: 'the complainant engaged the respondent's services to download weekly menus, discovering days later that the company had used her personal data - full name and profile photograph - and information about her cholesterol test results and her hypothyroidism condition.' Bearing (this factor): health data pulled into a marketing purpose engages Article 9, which Article 6(1)(f) cannot reach past. DARK pending ratification. | classify r2: stage3: both framings independently identified a categorical legal proposition and both quotes verified as real substrings — rule candidate | 2026-09-07 orchestrator review of r2 promotions: DEMOTED to pattern — the text states a rule, but not a rule on Article 6(1)(f) reliance usable in the LIA decision tree (doc 206D); rule_statement kept for reference",
    pipeline_stage: "stage3_consistency",
    extracted_quote: "El artículo 6.1 del RGPD, establece los supuestos que permiten considerar lícito el tratamiento de datos personales.",
    quote_verified: true,
    self_consistency_agreement: true,
    confidence_tier: "high",
    pipeline_version: "corpus-classify-v1-2026-09-06",
    classified_at: "2026-09-07T02:22:01.606+00:00",
  },
  "lia/f01-interest-legitimacy/ap-w5-17": {
    product: "lia",
    country: "ES",
    instrument: "EU GDPR",
    factor_ids: ["Interest legitimacy", "Safeguards and mitigations"],
    use_case_class: null,
    outcome_posture: "rejected",
    relationship: "customer",
    ...
    flags: [],
    rule_or_pattern: "pattern",
    curation_note: "Doc 73 watch row, wired 2026-09-05 (v5). AEPD (Spain), Vodafone Espana, S.A.U., 4 March 2020, EUR 60,000. SOURCE LANGUAGE: Spanish; pin verbatim. WORKING ENGLISH TRANSLATION: 'an employee of the Vodafone store impersonated him, registering with another operator to carry out the number port and supplying his identity document and data without consent, forging his signature.' Bearing (this factor): a commercial objective pursued by fraud is not a legitimate interest at all - the first limb of the three-part test fails before necessity or balancing is reached. DARK pending ratification. | classify r2: stage3: both framings agree the excerpt records an outcome on particular facts — stays pattern",
    pipeline_stage: "stage3_consistency",
    extracted_quote: null,
    quote_verified: false,
    self_consistency_agreement: true,
  ...
  "lia/f03-necessity/ap-w6-01": {
    ...
    country: "IE",
    instrument: "EU GDPR",
    factor_ids: ["Necessity and less-intrusive means", "Safeguards and mitigations"],
    ...
    flags: [],
    rule_or_pattern: "pattern",
    curation_note: "Doc 73 watch row, excerpt-extraction pass, wired 2026-09-05 (v5.1). DPC (Ireland), AirBnb Ireland UC, 2023-09-28, 28.09.2023 (complaint reference redacted). No key_compliance_failure on this row, so the pin is an exact substring of `source_document_text` (the stored decision text), clause-truncated to the pin budget. Bearing (this factor): where an equally effective, less intrusive verification route exists, Article 6(1)(f) fails at the necessity limb even though the safety interest itself was accepted as legitimate. DARK pending ratification. [doc205-backfill CORRECTION 2026-09-06: outcome_posture changed conditional->rejected. Source (gdprhub, DPC 28.09.2023) states plainly: \"The DPC found that Airbnb did not validly rely on Article 6(1)(f) of the GDPR as the legal basis for processing the Complainant's photographic ID and supplemental photographs\" -- an outright rejection of the claimed reliance, not a conditional/partial acceptance. Confirmed by doc 205A §8.4 and independently re-verified against source_document_text this session.] | classify r2: stage1: pattern-prior row holds: only plain modal language (is required), which every enforcement note carries — stays at its stage-0 classification",
    pipeline_stage: "stage0_prior",
    extracted_quote: null,
    quote_verified: false,
    self_consistency_agreement: null,
  ...
  "lia/f01-interest-legitimacy/ap-w6-02": {
    ...
    country: "IE",
    instrument: "EU GDPR",
    factor_ids: ["Interest legitimacy", "Necessity and less-intrusive means", "Balancing of interests, rights and freedoms"],
    use_case_class: "fraud_prevention",
    ...
    flags: [],
    rule_or_pattern: "pattern",
    curation_note: "Doc 73 watch row, excerpt-extraction pass, wired 2026-09-05 (v5.1). DPC (Ireland), Airbnb Ireland UC, 2023-09-14, Inquiry into Airbnb Ireland UC - 14 September 2023. No key_compliance_failure on this row, so the pin is an exact substring of `source_document_text` (the stored decision text), clause-truncated to the pin budget. Bearing (this factor): the authority worked from the controller's own written LIA when identifying the interest - a documented interest statement is what the first limb is tested against. DARK pending ratification. [doc205-backfill CORRECTION 2026-09-06: outcome_posture changed conditional->accepted (NOT rejected/unconfirmed as doc 205A §6.4 flagged pending fuller text). Full source_document_text (gdprhub, DPC decided 14.09.2023, \"Inquiry into Airbnb Ireland UC - September 2023\") contains a complete, explicit three-part-test walkthrough: purpose (\"a legitimate interest is given, as it is stated in the controller's LIA document that it has an interest in preserving the integrity of police investigations, in protecting itself from liability and keeping the platform safe\"), necessity (retention until expiry of the 6-year Cypriot limitation period, on legal advice, held necessary), and balancing (data subject's rights did not override, \"given the safety concerns related to the incident\"). Holding states directly: \"The DPC thus held that the controller validly relied on Article 6(1)(f) GDPR as a legal basis for retaining the data subject's personal data.\" The row's `violation` field listing \"Article 6(1)(f) GDPR\" is misleading -- it appears to list every article the decision analyzed, not only articles found violated; the only violation actually found here was Art. 12(4) (failure to keep the data subject updated). This is now the corpus's clearest fully-reasoned ACCEPTED reliance, stronger evidentially than the existing Archbishop of Dublin row.] | classify r2: stage3: both framings agree the excerpt records an outcome on particular facts — stays pattern",
    pipeline_stage: "stage3_consistency",
    extracted_quote: null,
    quote_verified: false,
    self_consistency_agreement: true,
  ...
  "lia/f08-safeguards/ap-w6-03": {
    product: "lia",
    country: "IE",
    instrument: "EU GDPR",
    factor_ids: ["Safeguards and mitigations", "Balancing of interests, rights and freedoms"],
    use_case_class: null,
    outcome_posture: "accepted",
    relationship: "public",
    data_categories: ["Other"],
  ...
  "lia/f04-balancing/ap-w6-04": {
    ...
    country: "IE",
    instrument: "EU GDPR",
    factor_ids: ["Balancing of interests, rights and freedoms", "Necessity and less-intrusive means"],
    use_case_class: "fraud_prevention",
    outcome_posture: "rejected",
    relationship: "customer",
    data_categories: ["Other", "Contact data"],
    flags: [],
    rule_or_pattern: "pattern",
    curation_note: "Doc 73 watch row, excerpt-extraction pass, wired 2026-09-05 (v5.1). DPC (Ireland), Airbnb Ireland UC, 2022-09-14, IN-21-3-1. No key_compliance_failure on this row, so the pin is an exact substring of `source_document_text` (the stored decision text), clause-truncated to the pin budget. Bearing (this factor): an undemonstrated proportionality case collapses the balance - the controller carries the burden of showing the interest outweighs the individual's rights. DARK pending ratification. [doc205-backfill CORRECTION 2026-09-06: outcome_posture changed conditional->rejected. Source (gdprhub, DPC decided 14.09.2022, IN-21-3-1) states: \"it could not be considered that a 'legitimate interest' exists for the processing of data and so the controller had infringed Article 6(1) GDPR\" -- an outright rejection, since Airbnb did not demonstrate the ID request was proportionate or necessary. Confirmed by doc 205A §8.4 and independently re-verified against source_document_text this session.] | classify r2: stage3: both framings agree the excerpt records an outcome on particular facts — stays pattern",
    pipeline_stage: "stage3_consistency",
    extracted_quote: null,
    quote_verified: false,
    self_consistency_agreement: true,
    confidence_tier: "high",
    pipeline_version: "corpus-classify-v1-2026-09-06",
    classified_at: "2026-09-07T01:46:00.872+00:00",
  },
  "lia/f05-reasonable-expectations/ap-w6-05": {
    product: "lia",
    country: "FR",
    instrument: "EU GDPR",
    factor_ids: ["Reasonable expectations of the data subject", "Balancing of interests, rights and freedoms"],
    use_case_class: null,
    outcome_posture: "rejected",
    relationship: "public",
    data_categories: ["Biometric data", "Special category data"],
    flags: ["special_category", "large_scale"],
    rule_or_pattern: "pattern",
    curation_note: "Doc 73 watch row, excerpt-extraction pass, wired 2026-09-05 (v5.1). CNIL (France), CLEARVIEW AI, 2021-11-26, MED-2021-134. No key_compliance_failure on this row, so the pin is an exact substring of `source_document_text` (the stored decision text), clause-truncated to the pin budget. Bearing (this factor): scraping publicly accessible images defeats reasonable expectations, so no legitimate interest was available and consent became the only route. DARK pending ratification. | classify r2: stage1: pattern-prior row holds: only plain modal language (must, is required), which every enforcement note carries — stays at its stage-0 classification",
    pipeline_stage: "stage0_prior",
    extracted_quote: null,
    quote_verified: false,
    self_consistency_agreement: null,
    confidence_tier: "high",
    pipeline_version: "corpus-classify-v1-2026-09-06",
    classified_at: "2026-09-07T01:28:01.591+00:00",
  },
  "lia/f04-balancing/ap-w6-07": {
    product: "lia",
    country: "FR",
    instrument: "EU GDPR",
    factor_ids: ["Balancing of interests, rights and freedoms", "Reasonable expectations of the data subject"],
    use_case_class: null,
    outcome_posture: "rejected",
    relationship: "public",
    data_categories: ["Other", "Contact data"],
  ...
  "lia/f01-interest-legitimacy/ap-w6-08": {
    product: "lia",
    country: "IE",
    instrument: "EU GDPR",
    factor_ids: ["Interest legitimacy", "Balancing of interests, rights and freedoms"],
  ...
  "lia/f11-eprivacy/ap-w6-09": {
    product: "lia",
    country: "FR",
    instrument: "EU GDPR",
    factor_ids: ["Special-category and ePrivacy interplay", "Relationship with the individual"],
    use_case_class: "direct_marketing",
    outcome_posture: "rejected",
    relationship: "prospect",
    data_categories: ["Contact data"],
    flags: ["electronic_marketing"],
    rule_or_pattern: "pattern",
    curation_note: "Doc 73 watch row, excerpt-extraction pass, wired 2026-09-05 (v5.1). CNIL (France), Nestor SAS, 2020-12-08, SAN-2020-018. No key_compliance_failure on this row, so the pin is an exact substring of `source_document_text` (the stored decision text), clause-truncated to the pin budget. Bearing (this factor): electronic-marketing rules impose consent and displace legitimate interests, so the Article 6(1)(f) route is unavailable no matter how the balance reads. DARK pending ratification. | classify r2: stage3: both framings agree the excerpt records an outcome on particular facts — stays pattern",
    pipeline_stage: "stage3_consistency",
    extracted_quote: null,
    quote_verified: false,
    self_consistency_agreement: true,
  ...
  "lia/f01-interest-legitimacy/ap-w6-10": {
    product: "lia",
    country: "FR",
    instrument: "EU GDPR",
    factor_ids: ["Interest legitimacy", "Necessity and less-intrusive means"],
    use_case_class: "contractual_administration",
    outcome_posture: "rejected",
    relationship: "customer",
    data_categories: ["Communications data", "Financial data"],
    flags: [],
    rule_or_pattern: "pattern",
    curation_note: "Doc 73 watch row, excerpt-extraction pass, wired 2026-09-05 (v5.1). CNIL (France), SPARTOO SAS, 2020-07-28, SAN-2020-003. No key_compliance_failure on this row, so the pin is an exact substring of `source_document_text` (the stored decision text), clause-truncated to the pin budget. Bearing (this factor): a blanket legal-basis statement is not precise enough; each purpose must name its own basis, and legitimate interests must be identified as such where relied on. DARK pending ratification. | classify r2: stage3: both framings agree the excerpt records an outcome on particular facts — stays pattern",
    pipeline_stage: "stage3_consistency",
    extracted_quote: null,
    quote_verified: false,
    self_consistency_agreement: true,
    confidence_tier: "high",
    pipeline_version: "corpus-classify-v1-2026-09-06",
    classified_at: "2026-09-07T02:04:01.06+00:00",
  },
  "lia/f06-relationship/ap-w6-11": {
    product: "lia",
    country: "PL",
    instrument: "EU GDPR",
    factor_ids: ["Relationship with the individual", "Interest legitimacy"],
    ...
    confidence_tier: "high",
    pipeline_version: "corpus-classify-v1-2026-09-06",
    classified_at: "2026-09-07T01:18:01.409+00:00",
  },
  "lia/f01-interest-legitimacy/ap-w6-12": {
    product: "lia",
    country: "ES",
    instrument: "Directive 95/46",
    factor_ids: ["Interest legitimacy"],
    use_case_class: null,
    ...
    flags: [],
    rule_or_pattern: "pattern",
    curation_note: "Doc 73 watch row, excerpt-extraction pass, wired 2026-09-05 (v5.1). AEPD (Spain), AMADEUS IT GROUP, S.A., 2016-04-27, EXP202315175. No key_compliance_failure on this row, so the pin is an exact substring of `source_document_text` (the stored decision text), clause-truncated to the pin budget. SOURCE LANGUAGE: Spanish; pin verbatim. WORKING ENGLISH TRANSLATION: 'Legal basis: Amadeus's legitimate interest in better understanding our services and improving them, identifying usage trends and developing new products.' Bearing (this factor): a legitimate interest stated at this level of generality (analytics, product development) is what the authority tested against the controller's own legitimate-interests assessment annexed to its DPIA. DARK pending ratification. [doc205-backfill CORRECTION 2026-09-06, CEO-approved per doc205 §12 item 3 / D5: instrument changed EU GDPR -> Directive 95/46. Decision date 2016-04-27 predates the GDPR's 2018-05-25 effective date; the decision is a \"RESOLUCIÓN DE TERMINACIÓN DEL PROCEDIMIENTO POR PAGO VOLUNTARIO\" (procedure terminated by voluntary payment/settlement) with no key_compliance_failure or legacy_summary_text field populated and no substantive DPA finding visible in the fields read -- outcome_posture=conditional is NOT independently confirmable from available text (matches doc 205A §8.4's \"UNCONFIRMED\" call) and confidence_tier is downgraded high->low accordingly. FOLLOW-UP (not fixed in this phase): CamRelevanceProfile.instrument in _shared/corpus/cam-types.ts and the generator product registry do not yet contain \"Directive 95/46\" as a valid value -- this row will be rejected/excluded by generate-corpus-relevance-profiles until doc 207 Track 2 adds the vocabulary value. Confirmed via dry-run this session.] | classify r2: stage1: pattern-prior row holds: no categorical or definitional language — stays at its stage-0 classification",
    pipeline_stage: "stage0_prior",
    extracted_quote: null,
    quote_verified: false,
    self_consistency_agreement: null,
    confidence_tier: "low",
    pipeline_version: "corpus-classify-v1-2026-09-06",
    classified_at: "2026-09-07T01:44:01.307+00:00",
  },
};
