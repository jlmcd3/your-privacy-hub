...
export const LIA_SLOT_MAP: readonly LiaSlotBinding[] = [
  ...
  { slot: "scaleApprox", paragraph: 27, kind: "intake", source: "balancing_details.scale_approx", render: "verbatim",
    absent: "the scale sentence is dropped" },
  { slot: "frequency", paragraph: 27, kind: "intake", source: "balancing_details.frequency", render: "adverbial",
    absent: "the scale sentence is dropped with it" },
  { slot: "duration", paragraph: 27, kind: "intake", source: "balancing_details.duration", render: "adverbial",
    absent: "the scale sentence is dropped with it" },
