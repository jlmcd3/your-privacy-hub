...
const ADMT_V3_FIXED = {
  applicability_requirement:
    "Article 11 applies when a business uses ADMT to make a significant decision about a consumer (11 CCR § 7200(a)). ADMT is technology that processes personal information and uses computation to replace or substantially replace human decisionmaking (11 CCR § 7001(e)). A human is meaningfully involved only when the reviewer (A) knows how to interpret and use the technology's output to make the decision, (B) reviews and analyzes that output and any other information relevant to make or change the decision, and (C) has the authority to make or change the decision based on that analysis (11 CCR § 7001(e)(1)(A)–(C)). A significant decision is one that results in the provision or denial of financial or lending services, housing, education enrollment or opportunities, employment or independent contracting opportunities or compensation, or healthcare services (11 CCR § 7001(ddd)). Advertising by itself is excluded from that definition (11 CCR § 7001(ddd)(6)).",
  ...
  optout_default_requirement:
    "A consumer generally has the right to opt out of a business's use of ADMT to make a significant decision (11 CCR § 7221(a)), unless the business qualifies for one of the following exceptions: the human-appeal exception, where consumers can appeal the decision to a human reviewer with authority to overturn it (11 CCR § 7221(b)(1)); the hiring/admission exception, where the business uses the ADMT solely to assess a consumer's ability to perform at work or in an educational program and the ADMT works for that purpose without unlawfully discriminating on protected characteristics (11 CCR § 7221(b)(2)(A)–(B)); or the work-allocation/compensation exception, on the same two conditions for allocating or assigning work or setting compensation (11 CCR § 7221(b)(3)(A)–(B)).",
...
function buildOutOfScopeConditions(scope: AdmtV2Computed["scope"], systemName: string): RenderedParagraph[] {
  ...
  const paras: RenderedParagraph[] = [
    ...
    { kind: "skeleton", text: "Scope qualification — conditions on this determination" },
    { kind: "skeleton", text: `This determination rests on the reported human review operating in practice for every significant decision ${systemName} touches. Qualifying review under 11 CCR § 7001(e)(1) means the reviewer knows how to interpret and use the output to make the decision, reviews and analyzes it together with any other information relevant to make or change the decision, and has the authority to make or change the decision based on that analysis — for each decision, not in the aggregate. Where a decision is made without that review, the System is ADMT for that decision, and the Article 11 duties this report does not reach — the Pre-use Notice, the opt-out or exception, and consumer access and explanation — apply to it.` },
  ];
