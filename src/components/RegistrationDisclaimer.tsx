...
export default function RegistrationDisclaimer({
  ...
  if (variant === "compact") {
    return (
      <p className="text-[11px] text-muted-foreground leading-relaxed border-t border-border/40 pt-3 mt-4">
        Your Privacy Hub's Registration Manager generates draft filings and checklists tailored to your inputs.
  ...
  return (
    <div className="rounded-lg border border-amber-200 bg-amber-50 p-4 text-[12.5px] leading-relaxed text-amber-900">
      ...
      <p>
        Your Privacy Hub's Registration Manager produces <strong>draft documents and filing checklists</strong> based
      ...
      <p className="mt-2">
        ...
        (special-category data, AI Act high-risk systems, or cross-border transfers). Your Privacy Hub is not
