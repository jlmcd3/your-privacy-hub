...
const REGIONAL_CATEGORIES = [
  { name: "EU & UK",            icon: "🇪🇺", slug: "eu-uk",        lat: 50.0,  lon: 10.0,   tagline: "Track GDPR enforcement, UK DUAA, and European regulatory developments.",  href: "/category/eu-uk" },
  { name: "U.S. Federal",       icon: "🇺🇸", slug: "us-federal",   lat: 38.9,  lon: -77.0,  tagline: "FTC actions, federal privacy bills, and executive orders on data.",        href: "/category/us-federal" },
  { name: "U.S. State Laws",    icon: "🗺️", slug: "us-states",    lat: 37.0,  lon: -96.0,  tagline: "19 state privacy laws and counting — track every bill and effective date.", href: "/category/us-states" },
  { name: "AI & Privacy",       icon: "🤖", slug: "ai-privacy",   lat: 37.4,  lon: -122.0, tagline: "EU AI Act, algorithmic audits, and the frontier of AI governance.",        href: "/category/ai-privacy" },
  { name: "AdTech",             icon: "📡", slug: "adtech",       lat: 40.7,  lon: -74.0,  tagline: "Cookie consent, programmatic advertising, and tracking enforcement.",      href: "/category/adtech" },
  { name: "Enforcement",        icon: "⚖️", slug: "enforcement",  lat: 50.8,  lon: 4.4,    tagline: "GDPR fines, DPA decisions, and global enforcement actions.",               href: "/category/enforcement" },
  { name: "Global",             icon: "🌐", slug: "global",       lat: 1.3,   lon: 103.8,  tagline: "Privacy developments from Asia-Pacific, Africa, and Latin America.",       href: "/category/global" },
];

type Phase = "idle" | "spinning" | "result";
type RegionalCategory = typeof REGIONAL_CATEGORIES[number];
...
export default function SpinTheGlobe({ compact = false }: { compact?: boolean } = {}) {
  ...
  const handleSpin = useCallback(() => {
    ...
    const pick = REGIONAL_CATEGORIES[Math.floor(Math.random() * REGIONAL_CATEGORIES.length)];
