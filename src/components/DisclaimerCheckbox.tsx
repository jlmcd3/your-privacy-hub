  ...
  return (
    <label className="flex items-start gap-2.5 cursor-pointer mt-4 p-3 bg-gold/10 border border-gold/20 rounded-xl">
      ...
      <span className="text-[11px] text-amber-800 leading-relaxed">
        I understand this document is generated by artificial intelligence, is not legal advice, and must be reviewed by qualified legal counsel before any operational use or reliance. I accept all risk of reliance without such review.
      </span>
    </label>
  );
}
