  ...
  return (
    <div className="bg-muted/50 border-y border-border text-center px-4 h-9 flex items-center justify-center">
      <p className="text-[11px] text-muted-foreground truncate">
        ...
        <span className="text-amber-600 font-semibold">{`⭐ Intelligence ${INTELLIGENCE_PRICING.monthlyShort()} — full archive, watchlists, enforcement tracking, plus Privacy Notices included and RoPA free on annual plans (first build + 1 update/yr, then $39) · Annual Professional adds 3 free Smart Tool runs/yr (Intelligence annual: 1)`}</span>
        <span className="text-border mx-1.5">·</span>
