          ...
          <div className="mt-4">
            ...
            {resolved && (
              <div className="border border-brand-cloud rounded-xl bg-card p-5">
                <p className="text-eyebrow text-brand-teal mb-1">Recommended tool</p>
                ...
                <div className="flex flex-wrap gap-3 items-center">
                  <Link
                    to={resolved.href}
                    className="text-sm font-semibold bg-brand-teal text-white px-4 py-2 rounded-lg no-underline hover:opacity-90"
                  >
                    Open {resolved.name} →
                  </Link>
                  {sampleSlug && (
