  ...
  return (
    <div className="border-t border-border/40 pt-3 mt-4 space-y-1.5">
      <p className="text-meta text-muted-foreground leading-relaxed">
        This document was generated by artificial intelligence, not by a licensed attorney, and does not constitute legal advice, legal services, or the practice of law — automatically generated content may contain errors or inaccuracies, may not reflect current law, and may not apply to your jurisdiction; it must be reviewed and approved by qualified legal counsel before any operational use or reliance.
      </p>
      <p className="text-meta text-muted-foreground leading-relaxed">
