    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { icon: "🛰️", label: "Your Regulatory Watchlist", badge: "NEW", badgeGreen: true, href: "/horizon" },
          ...
          { icon: "👁️", label: "Biometric Compliance Checker", badge: "NEW", badgeGreen: true, href: "/biometric-checker" },
        ],
      },
    ],
  },
