    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { icon: "⭐", label: "Your Regulatory Watchlist", badge: "NEW", badgeGreen: true, href: "/horizon" },
          { icon: "⭐", label: "Your Registration Filings", badge: "NEW", badgeGreen: true, href: "/registration-manager" },
          { icon: "⭐", label: "Legitimate Interest Assessment Tool", badge: "PRO", href: "/li-assessment" },
          { icon: "⭐", label: "Privacy Program Assessment Tool", badge: "PRO", href: "/governance-assessment" },
          { icon: "⭐", label: "Impact Assessment Builder", badge: "PRO", href: "/dpia-framework" },
          { icon: "⭐", label: "Your Custom DPA", badge: "NEW", badgeGreen: true, href: "/dpa-generator" },
          { icon: "⭐", label: "Your Breach Response Playbook", badge: "NEW", badgeGreen: true, href: "/ir-playbook" },
          { icon: "⭐", label: "Biometric Compliance Checker", badge: "NEW", badgeGreen: true, href: "/biometric-checker" },
        ],
      },
    ],
  },
