    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { icon: <Compass aria-hidden="true" strokeWidth={1.75} />, label: "Explore all free tools →", href: "/explore", bottom: true },
        ],
      },
    ],
  },
    ...
    sections: [
      {
        ...
        items: [
          ...
          { icon: <FileSignature aria-hidden="true" strokeWidth={1.75} />, label: "Custom DPA", href: "/dpa-generator",
      ...
      },
      {
        ...
        items: [
          ...
          { icon: <ClipboardList aria-hidden="true" strokeWidth={1.75} />, label: "US Privacy Notice", href: "/us-notice-builder",
            tooltip: "State-specific notices: CCPA, Virginia, Colorado, and more. Free within Intel/Pro pool." },
          { icon: <Globe aria-hidden="true" strokeWidth={1.75} />, label: "EU / Global Privacy Notice", href: "/eu-global-notice-builder",
            tooltip: "GDPR Article 13/14 notices with multi-jurisdiction overlays. Free within Intel/Pro pool." },
          { icon: <ClipboardList aria-hidden="true" strokeWidth={1.75} />, label: "Record of Processing Activities (RoPA)", href: "/ropa-builder",
            tooltip: "Versioned Article 30 record of processing activities. Free within Intel/Pro pool." },
          { icon: <Folder aria-hidden="true" strokeWidth={1.75} />, label: "Registration Filings Manager", href: "/registration-manager",
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { icon: <BookOpen className="w-4 h-4 text-muted-foreground" />, label: "Research home →", href: "/research", bottom: true },
        ],
      },
    ],
  },
