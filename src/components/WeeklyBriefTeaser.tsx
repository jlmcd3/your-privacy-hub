    ...
    <section className="py-16 px-8 bg-card">
      <div className="max-w-[1280px] mx-auto">
        <div className="flex justify-between items-end mb-8">
          <div>
            <h2 className="font-display text-[26px] tracking-tight text-navy">This Week's Intelligence Brief</h2>
        ...
        <div className="relative bg-gradient-to-br from-[#0A1929] to-navy rounded-2xl p-9 overflow-hidden border border-navy-light">
          <div className="absolute top-6 right-7 text-[10px] font-bold tracking-[0.12em] text-slate">WEEK 10 · 2026</div>
          ...
          <p className="text-[13.5px] text-slate-light leading-relaxed mb-5 max-h-20 overflow-hidden" style={{
          ...
          <div className="flex flex-wrap gap-1.5 mb-5">
            {sections.map((s) => (
              <span
                key={s.label}
                className={`text-[11px] font-medium px-2.5 py-1 rounded-full bg-white/[0.06] border border-white/10 text-slate-light ${
                  s.locked ? "opacity-50" : ""
                }`}
              >
                {s.locked ? "🔒 " : ""}{s.label}
