...
export const CPPA_RISK_VARIANTS = [
  ...
  },
  {
    ...
    q5_sell_share: "Sharing only",
    q6_right_know: "Authenticated in-app request flow",
    q7_right_delete: "Automated where regulatory retention allows",
    q8_right_correct: "Self-serve in account portal",
    q9_opt_out: "Yes, prominent global control",
    q10_id_verification: "Authenticated session + MFA challenge",
    q11_policy_review: "Within last 12 months",
    q12_notice_at_collection: "Yes, comprehensive",
    q13_notice_content: "All elements",
    q14_employee_notice: "Yes — dedicated employee notice",
    q15_sensitive_pi: "Yes",
    q16_sensitive_limit: "Yes",
    q17_sensitive_basis: "Service delivery, fraud prevention, regulatory compliance",
    q18_admt_use: "Yes",
    q19_admt_description: "Real-time fraud-scoring model for card-not-present transactions.",
    q20_admt_opt_out: "Yes, with manual-review fallback",
    ...
    i2_retention_criteria: "Regulatory retention requirement",
    i2_retention_detail: "Bank Secrecy Act + state banking regulations.",
    i3_ca_consumer_band: "100,001 – 1,000,000",
    i4_disclosure_mechanisms: ["Notice at Collection", "Privacy policy", "Account dashboard"],
  ...
  },
  {
    ...
    q5_sell_share: "Both",
    q6_right_know: "Online form with identity verification",
    q7_right_delete: "Automated workflow",
    q8_right_correct: "Self-serve in account portal",
    q9_opt_out: "Yes, prominent global control",
    q10_id_verification: "Authenticated session",
    q11_policy_review: "Within last 12 months",
    q12_notice_at_collection: "Yes, comprehensive",
    q13_notice_content: "All elements",
    q14_employee_notice: "Yes — dedicated employee notice",
    ...
    i2_retention_criteria: "Statutory tax retention",
    i2_retention_detail: "California tax records retention.",
    i3_ca_consumer_band: "More than 1,000,000",
    i4_disclosure_mechanisms: ["Notice at Collection", "Privacy policy", "Cookie banner"],
  ...
  },
  {
    ...
    q5_sell_share: "Neither",
    q6_right_know: "Email request to privacy mailbox",
    q7_right_delete: "Manual process, documented",
    q8_right_correct: "Handled via HR",
    q9_opt_out: "n/a (no sale/share)",
    q10_id_verification: "Authenticated employee portal",
    q11_policy_review: "12–24 months ago",
    q12_notice_at_collection: "Yes, comprehensive",
    q13_notice_content: "All elements",
    q14_employee_notice: "Yes — dedicated employee notice",
    q15_sensitive_pi: "Yes",
    q16_sensitive_limit: "Yes",
    q17_sensitive_basis: "Safety monitoring and statutory compliance",
    q18_admt_use: "No",
    ...
    i3_ca_consumer_band: "Fewer than 100,000",
    i4_disclosure_mechanisms: ["Employee notice", "Privacy policy"],
