...
export const PRICING = {
  ...
  tools: {
    ...
    cppa_cyber:   { name: 'CPPA Cybersecurity Audit Readiness',       dollars: 399, display: '$399', stripePriceId: 'cppa_cyber_standalone' },
    ...
    cppaCyber:    { name: 'CPPA Cybersecurity Audit Readiness',       dollars: 399, display: '$399', stripePriceId: 'cppa_cyber_standalone' },
