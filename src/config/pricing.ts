...
export const PRICING_REGISTRY = {
  ...
  ir_subscriber_v2: {
    ...
    productKey: "ir_v8",
    productName: "Breach Response Playbook (Subscriber)",
  ...
  ropa_initial_subscriber: {
    ...
    description: "Subscriber per-use price for RoPA initial generation.",
    amountCents: 4900,
    currency: "usd",
    displayPrice: "$49",
    displaySuffix: " flat",
  ...
  ropa_refresh_subscriber: {
    ...
    description: "Subscriber per-use price for RoPA annual refresh.",
    amountCents: 4900,
    currency: "usd",
    displayPrice: "$49",
    displaySuffix: " flat",
