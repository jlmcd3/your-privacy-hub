...
export const PRICING = {
  ...
  tools: {
    ...
    lia:          { name: 'Legitimate Interest Assessment',     dollars: 99,  display: '$99',  stripePriceId: 'li_standalone_v2' },
    us_notice:    { name: 'US Privacy Notice Builder',          dollars: 0,   display: 'Included with subscription', stripePriceId: null },
    dpia:         { name: 'Data Protection Impact Assessment',  dollars: 99,  display: '$99',  stripePriceId: 'dpia_standalone_v2' },
