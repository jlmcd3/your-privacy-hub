...
function DivergenceTracker() {
  return (
    <div className="rounded-xl border border-brand-teal/30 bg-brand-teal/5 p-4 md:p-5">
      <div className="text-eyebrow uppercase tracking-wider text-brand-teal-text font-semibold mb-3">
    ...
    <details className="rounded-xl border border-brand-cloud bg-card group">
      ...
      <div className="px-4 pb-4 pt-1 text-sm text-brand-navy leading-relaxed space-y-3">
        <p>
          ...
          <Link to="/regulator/dpc" className="text-brand-teal-text no-underline hover:underline">Data Protection Commission (DPC)</Link> for
          transfers to the U.S. without adequate safeguards (2023), <strong>Amazon's €746 million</strong> from
          Luxembourg's <Link to="/regulator/cnpd" className="text-brand-teal-text no-underline hover:underline">National Data Protection Commission (CNPD)</Link>{" "}
        ...
        <p>
          ...
          <Link to="/regulator/dpc" className="text-brand-teal-text no-underline hover:underline">DPC</Link>), France (
          <Link to="/regulator/cnil" className="text-brand-teal-text no-underline hover:underline">National Commission on Informatics and Liberty (CNIL)</Link>), Luxembourg (
          <Link to="/regulator/cnpd" className="text-brand-teal-text no-underline hover:underline">CNPD</Link>), Italy (
          <Link to="/regulator/garante" className="text-brand-teal-text no-underline hover:underline">Italian Data Protection Authority (Garante)</Link>), and Spain (
          <Link to="/regulator/aepd" className="text-brand-teal-text no-underline hover:underline">Spanish Data Protection Agency (AEPD)</Link>)</strong>. The{" "}
          <Link to="/regulator/edpb" className="text-brand-teal-text no-underline hover:underline">European Data Protection Board (EDPB)</Link> has
        ...
        <p>
          <Link to="/enforcement-tracker" className="text-brand-teal-text font-semibold no-underline hover:underline">
