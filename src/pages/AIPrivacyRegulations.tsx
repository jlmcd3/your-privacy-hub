  ...
  <ResearchPageLayout
    ...
    sections={[
      ...
      },
      {
        ...
        content: `<p>Enforcement at the AI–privacy intersection is accelerating, but recent court rulings show that AI-related sanctions are also being tested on appeal. Italy's <a href="https://www.garanteprivacy.it/home_en" target="_blank" rel="noopener noreferrer">Garante</a> <a href="https://www.garanteprivacy.it/web/guest/home/docweb/-/docweb-display/docweb/9870832" target="_blank" rel="noopener noreferrer">temporarily banned ChatGPT in 2023</a> and, in Decision No. 755 of 2 November 2024, imposed a €15 million fine on OpenAI. That decision was overturned by judgment No. 4153/2026 of the Court of Rome (published 18 March 2026). The <a href="https://www.ftc.gov/business-guidance/blog/2023/02/keep-your-ai-claims-check" target="_blank" rel="noopener noreferrer">FTC</a> has taken action against companies using AI for deceptive practices. The <a href="https://www.edpb.europa.eu/our-work-tools/our-documents/coordinated-enforcement-action_en" target="_blank" rel="noopener noreferrer">EDPB's coordinated enforcement framework</a> has prioritized AI as a focus area.</p>`,
      },
    ]}
    relatedLinks={[
