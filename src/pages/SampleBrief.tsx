...
const enforcementRows = [
  {
    ...
    jur: "UK",
    co: "TikTok Ltd",
    viol: "Children's data without parental consent",
    fine: "£12.7M",
    date: "Mar 3, 2026",
    url: "https://ico.org.uk/about-the-ico/media-centre/news-and-blogs/2023/04/ico-fines-tiktok-12-7-million-for-misusing-childrens-data/",
  },
  {
    reg: "Texas AG",
    jur: "US — Texas",
    co: "DataConnect Inc.",
    viol: "TDPSA: selling sensitive data without consent",
    fine: "$14.2M",
    date: "Mar 9, 2026",
    url: "https://www.texasattorneygeneral.gov/consumer-protection/data-privacy",
  },
  {
    reg: "CNIL (France)",
    jur: "EU — France",
    co: "Clearview AI",
    viol: "Unlawful biometric data processing",
    fine: "€20M",
    date: "Mar 8, 2026",
    url: "https://www.cnil.fr/en/facial-recognition-cnil-fines-clearview-ai-20-million-euros",
  },
  {
    reg: "AEPD (Spain)",
    jur: "EU — Spain",
    co: "CaixaBank",
    viol: "Insufficient legal basis for profiling",
    fine: "€6.2M",
    date: "Mar 5, 2026",
    url: "https://www.aepd.es/en/press-and-communication/notes-of-press",
  },
];
...
const actionItems = [
  ...
  {
    text: "Deploy ADMT pre-use notices by March 31. California's ADMT regulations take effect April 1. Any automated system affecting employment, housing, credit, or education for California residents requires a pre-use opt-out notice.",
    url: "https://cppa.ca.gov/regulations/consumer_privacy_act.html",
  },
  {
    text: "Begin LGPD transfer mechanism review now. Brazil's new SCC requirement for international transfers has a 90-day window. Organizations transferring data from Brazil should complete gap assessments and execute SCCs or obtain consent before June 14, 2026.",
        ...
        <section className="bg-gradient-to-br from-navy via-navy-light to-navy py-14 px-4">
          <div className="max-w-[760px] mx-auto text-center">
            ...
            <p className="text-slate-light text-[15px] max-w-[600px] mx-auto mb-6">
              ...
              every significant privacy regulatory development from the prior week, re-analyzed specifically for their
          ...
          <div className="bg-white rounded-2xl shadow-2xl overflow-hidden mb-10">
            ...
            <div className="bg-gradient-to-r from-navy to-steel px-8 py-6">
              ...
              <h2 className="font-display text-[22px] md:text-[26px] text-white font-bold leading-tight mb-3">
                ICO Issues £12.7M TikTok Fine for Children's Data Violations; Texas AG Files First TDPSA Action; EDPB
                Adopts Binding AI Training Guidance
              </h2>
              ...
              <div className="px-8 py-2 divide-y divide-slate-100">
                ...
                <section id="exec" className="py-8">
                  ...
                  <p className="text-[15px] text-slate-700 leading-relaxed">
                    This week's dominant regulatory theme is enforcement convergence: three separate authorities — the
                    UK ICO, Texas AG, and EU EDPB — each took significant action within the same seven-day window,
                    signaling accelerating enforcement activity across all major jurisdictions simultaneously. The ICO's
                    £12.7 million fine against TikTok for processing children's data without adequate parental consent
                    establishes a new benchmark for children's privacy enforcement under UK GDPR, and is expected to
                    trigger follow-on investigations by EU DPAs under the GDPR's one-stop-shop mechanism. In the US, the
                    Texas Attorney General's filing against DataConnect Inc. under the TDPSA marks the first enforcement
                    action under the new state law, confirming that state AGs are prepared to act immediately where
                    federal privacy legislation remains stalled. Meanwhile, the EDPB's Opinion 28/2026 on AI training
                    data creates binding compliance obligations for any organization operating in the EU that uses
                    personal data to train AI models — a development with immediate implications for technology
                    companies, financial institutions, and any organization deploying generative AI tools.
                  </p>
                </section>
                ...
                <section id="us-federal" className="py-8">
                  ...
                  <p className="text-[15px] text-slate-700 leading-relaxed">
                    No major federal privacy legislation advanced this week. However, the FTC continued its active
                    enforcement posture with two new rulemakings: a proposed rule on rental housing fee transparency and
                    a negative-option marketing rule. Neither directly concerns privacy, but both signal the FTC's
                    sustained use of its Section 5 authority in consumer protection contexts adjacent to data practices.
                    Privacy counsel should note that the FTC's current rulemaking pace suggests the agency is building
                    an enforcement infrastructure that could pivot to AI and data practices rapidly once political
                    conditions allow. No new NIST framework updates this week.
                  </p>
                </section>
                ...
                <section id="us-states" className="py-8">
                  ...
                  <p className="text-[15px] text-slate-700 leading-relaxed">
                    Texas leads enforcement activity this week with the first TDPSA action (see enforcement table).
                    Three states to watch in the next 90 days: (1) Texas — AG has signaled further TDPSA enforcement
                    actions are imminent, particularly against data brokers. (2) California — CPPA's ADMT regulations
                    take effect April 1, 2026; organizations with automated decision-making systems affecting
                    employment, housing, or credit must have pre-use notices and opt-out mechanisms in place. (3) New
                    York — SHIELD Act enforcement activity has increased; the NY AG's office filed 3 data breach
                    enforcement actions in the past 30 days. Compliance teams operating in multiple US states should
                    prioritize: data broker registration filings (Texas, California, Oregon, Montana); ADMT notice
                    deployment for California; and data breach notification procedure review for New York.
                  </p>
                </section>
                ...
                <section id="eu-uk" className="py-8">
                  ...
                  <p className="text-[15px] text-slate-700 leading-relaxed">
                    The ICO's £12.7M TikTok fine is the largest UK GDPR children's privacy fine to date and the
                    second-largest UK GDPR fine overall. The ICO found that TikTok failed to obtain valid parental
                    consent for users under 13 and failed to implement adequate age verification. Significantly, the ICO
                    rejected TikTok's legitimate interests argument for processing children's data for algorithmic
                    recommendations — a ruling with broad implications for any platform that targets or knowingly serves
                    minors. EU DPAs are expected to open parallel investigations under Article 60 GDPR. The EDPB's
                    Opinion 28/2026 on AI training data establishes that: (1) scraping personal data from public sources
                    without a GDPR-compliant legal basis constitutes a violation regardless of whether the data was
                    originally public; (2) legitimate interests cannot justify AI training on personal data without a
                    robust balancing test; (3) data minimization obligations apply to AI training datasets. This opinion
                    is binding on all EU DPAs and will directly affect every organization using EU residents' personal
                    data in AI model training.
                  </p>
                </section>
                ...
                <div className="ml-0 pl-4 border-l-4 border-amber-400 bg-amber-50/50 rounded-r-xl py-4 pr-4 my-2">
                  ...
                  <p className="text-[14px] text-slate-700 leading-relaxed mb-3">
                    The ICO's TikTok ruling has a direct implication that most healthcare platforms will miss: the{" "}
                    <strong>legitimate interests prohibition for algorithmic personalization</strong> now established by
                    the ICO applies to pediatric health app recommendation engines and patient portal personalization
                    for users under 13. If your platform serves or may serve users under 18, your consent mechanisms and
                    personalization logic need immediate review under both UK GDPR and COPPA.
                  </p>
                  <p className="text-[14px] text-slate-700 leading-relaxed mb-3">
                    The EDPB's Opinion 28/2026 on AI training data creates a specific and urgent problem for healthcare
                    AI developers: the opinion's prohibition on scraping personal data for AI training without a
                    GDPR-compliant legal basis directly implicates any organization that has used EU patient records,
                    clinical notes, or diagnostic imaging to train diagnostic AI models. The Article 9 special category
                    data obligation compounds this — health data processed for AI training requires explicit consent or
                    a specific Article 9(2) exemption. Review your AI training datasets against this opinion before Q2
                    DPA inquiries begin.
                  </p>
                  <div className="bg-amber-100/80 rounded-lg px-4 py-3 mt-3 mb-3">
                    ...
                    <p className="text-[13px] text-amber-900 leading-relaxed">
                      Audit pediatric portal personalization and any AI training datasets containing EU patient data.
                      EDPB enforcement coordination is expected in Q2-Q3. Healthcare operators have the shortest lead
                      time — the Article 9 analysis must be completed and documented before the first DPA inquiry lands.
                    </p>
                  </div>
                ...
                <section id="global" className="py-8">
                  ...
                  <p className="text-[15px] text-slate-700 leading-relaxed">
                    Brazil's ANPD published Resolution No. 19 establishing standard contractual clauses for
                    international data transfers — the first formal transfer mechanism under the LGPD. Organizations
                    transferring personal data from Brazil to the US, EU, or APAC must now either use these SCCs or
                    obtain explicit consent. The 90-day implementation period ends June 14, 2026. Canada's Bill C-27
                    (CPPA/AIDA) remains stalled in committee but parliamentary sources indicate a vote is expected
                    before summer recess. Organizations with Canadian operations should begin CPPA compliance gap
                    assessments now. Singapore's PDPC issued updated AI governance guidelines expanding the definition
                    of 'significant decisions' subject to human review requirements.
                  </p>
                </section>
                  ...
                  <div className="overflow-x-auto rounded-xl border border-slate-100">
                    <table className="w-full text-[12px] text-left">
                      <thead className="bg-slate-50 border-b border-slate-200">
                        <tr>
                          <th className="pb-3 pr-3 pt-3 font-semibold text-[10px] uppercase tracking-wider text-slate-500 first:pl-4 last:pr-4">
                            Regulator
                          </th>
                          <th className="pb-3 pr-3 pt-3 font-semibold text-[10px] uppercase tracking-wider text-slate-500">
                            Jurisdiction
                          </th>
                          <th className="pb-3 pr-3 pt-3 font-semibold text-[10px] uppercase tracking-wider text-slate-500">
                            Company
                          ...
                          <th className="pb-3 pr-3 pt-3 font-semibold text-[10px] uppercase tracking-wider text-slate-500 last:pr-4">
                            Source
                          </th>
                        </tr>
                      </thead>
                      <tbody>
                        {enforcementRows.map((r, i) => (
                          <tr
                            key={i}
                            className={`${i % 2 === 0 ? "bg-white" : "bg-slate-50/50"} border-b border-slate-100`}
                          >
                            ...
                            <td className="py-2.5 pr-4 whitespace-nowrap">
                              <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className="text-blue-600 hover:underline text-[11px] font-medium no-underline hover:underline transition-colors"
                              >
                                View ↗
                              </a>
                            </td>
                ...
                <section id="trend" className="py-8">
                  ...
                  <p className="text-[15px] text-slate-700 leading-relaxed">
                    Week-over-week pattern: Enforcement volume is up 40% compared to the same period in 2025. The
                    concentration of simultaneous enforcement actions across UK, US, and EU in a single week is unusual
                    and suggests coordinated intelligence-sharing between regulators — a pattern that has preceded major
                    enforcement waves in the past (see 2021 GDPR enforcement surge). The 30-90 day outlook:
                    organizations should expect (1) follow-on EU investigations against TikTok within 60 days; (2)
                    additional Texas TDPSA enforcement actions against data brokers within 30 days; (3) first ADMT
                    enforcement actions from CPPA in Q2 2026 following the April 1 effective date. The EDPB AI training
                    opinion is likely to be followed by coordinated DPA investigations against major AI developers in
                    Q2-Q3 2026.
                  </p>
                </section>
