...
const comparisonRows: ComparisonRow[] = [
  ...
  { feature: "Incident Response Playbook (Convenience)", free: false, intel: `${PRICING.tools.ir_playbook.display} per playbook`, platform: "Included" },
  { feature: "Biometric Compliance Assessment (Smart Tool)", free: false, intel: `${PRICING.tools.biometric.display} per assessment`, platform: "Included" },
  { feature: "Record of Processing Activities (RoPA), subscriber-only", free: "—", intel: "Free on annual (1 update/yr, then $39) · $49/generation monthly", platform: "Free on annual (1 update/yr, then $39) · $49/generation monthly" },
  ...
  { feature: "CPPA Cybersecurity Audit Readiness (Smart Tool)", free: false, intel: T.cppa_cyber.display, platform: T.cppa_cyber.display },
