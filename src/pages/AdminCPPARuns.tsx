                    ...
                    {rows.slice(0, 50).map((r) => (
                      <tr key={r.id} className="border-t">
                        ...
                        <td className="p-2 font-mono text-[10px]">
                          <Link to={r.module === "admt" ? `/cppa-admt-checker/result/${r.id}` : r.module === "cybersecurity" ? `/cppa-cybersecurity/result/${r.id}` : `/cppa-risk-assessment/result/${r.id}`} className="text-brand-teal-text hover:underline">
                            {r.id.slice(0, 8)}
                          </Link>
                        </td>
                      </tr>
