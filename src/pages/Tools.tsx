...
const TOOLS: ToolDef[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "The output is a notice ready for review by your privacy or legal professional before publication. It is structured to be read by counsel quickly (clearly delineating the state-specific provisions from the universal ones), and to be updated as state laws continue to evolve. The U.S. Privacy Notice Builder is included with any Intelligence or Professional subscription (monthly or annual) and is not sold as a standalone product.",
    ],
    sampleSections: [
