...
const TOOLS: ToolDef[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "The Data Protection Impact Assessment (DPIA) produces a structured assessment aligned to EDPB guidelines, including the necessity and proportionality analysis most templates omit, with cited supervisory authority decisions.",
  ...
  },
  {
    ...
    section: "documents",
    icon: iconEl(Folder),
    name: "Record of Processing Activities (RoPA) (Article 30)",
    ...
    body: [
      "Article 30 RoPAs look administrative until a regulator asks for them. Then the gap between a spreadsheet that nominally lists processing activities and a record that actually demonstrates accountability becomes immediately visible. The Record of Processing Activities (RoPA) is structured around the latter.",
      ...
      "The output is a versioned, dated record intended to be reviewed by your privacy or legal professional and retained as part of your accountability documentation. Record of Processing Activities (RoPA) requires an Intelligence or Professional subscription and is not sold as a standalone product. On annual plans the first build is free and each subscription year includes one free update; additional updates are $39. On monthly plans each build or update is $49.",
  ...
  },
  {
    ...
    body: [
      ...
      "The US Privacy Notice produces state-specific notices that include the disclosures each statute actually requires: categories of personal information, sources, purposes, sale and sharing disclosures, sensitive data handling, and consumer rights mechanisms. State-specific overlays are applied automatically based on the jurisdictions you select.",
      "The output is a notice ready for review by your privacy or legal professional before publication. It is structured to be read by counsel quickly (clearly delineating the state-specific provisions from the universal ones), and to be updated as state laws continue to evolve. The US Privacy Notice is included with any Intelligence or Professional subscription (monthly or annual) and is not sold as a standalone product.",
    ],
    sampleSections: [
  ...
  },
  {
    ...
    body: [
      ...
      "The EU / Global Privacy Notice produces a GDPR and UK GDPR-aligned notice covering each Article 13/14 disclosure: identity of the controller, contact details, lawful basis per processing purpose, recipients, retention, international transfer safeguards, and data subject rights. International transfer language is calibrated to the destinations and mechanisms you specify (SCCs, adequacy, derogations).",
      "The generated notice is structured for review by your privacy or legal professional and intended to be the basis of a documented review, not a substitute for one. The EU / Global Privacy Notice is included with any Intelligence or Professional subscription (monthly or annual) and is not sold as a standalone product.",
    ],
    sampleSections: [
  ...
  },
  {
    ...
    body: [
      ...
      "The Registration Filings Manager begins with a free assessment: organisation type, size, sectors, and the markets in which you operate. From that, it produces a recommended registration footprint across 50+ jurisdictions — flagging where DPO registration, controller registration, representative appointment, and AI Act notification are required, and on what timeline.",
...
const PRICING_GRID: [string, string][] = [
  ...
  ["Custom DPA", `Included with Professional · ${PRICING.tools.dpa.display} standalone`],
  ...
  ["Record of Processing Activities (RoPA)", "Free on annual plans (first build + 1 update/yr), then $39 · $49 per build on monthly"],
  ["US Privacy Notice", "Included with subscription"],
  ["EU / Global Privacy Notice", "Included with subscription"],
