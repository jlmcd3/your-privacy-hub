...
const TESTS: TestEntry[] = [
  ...
  { id: "dpa-us", label: "DPA — US State", path: "/admin/test-dpa-us", group: "Documents" },
  { id: "dpa-dual", label: "DPA — Dual Compliance", path: "/admin/test-dpa-dual", group: "Documents" },
  { id: "dpa-canada", label: "DPA — Canadian", path: "/admin/test-dpa-canada", group: "Documents" },
  { id: "ir", label: "IR Playbook", path: "/admin/test-ir-playbook", group: "Documents" },
  { id: "ir-us", label: "IR Playbook — US/Canada", path: "/admin/test-ir-playbook-us", group: "Documents" },
