...
const SHORTCUTS: Array<{ label: string; to: string; group: string }> = [
  ...
  { group: "Users",   label: "All people",          to: "/admin/people" },
  { group: "Users",   label: "Registered users",    to: "/admin/registered-users" },
  { group: "Users",   label: "Trials & subscribers", to: "/admin/subscribers" },
  { group: "Users",   label: "Policy versions",     to: "/admin/PP-ToS" },
  { group: "Users",   label: "Support log",         to: "/admin/support" },
  { group: "Ops",     label: "Jurisdiction audit",  to: "/admin/jurisdiction-audit" },
  ...
  { group: "Ops",     label: "Provision registry",  to: "/admin/provisions" },
];
