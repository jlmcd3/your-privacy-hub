...
export default function AllPTest() {
  ...
  // product at random (fifteen per product under src/lib/ptestPanels);
  ...
  const run = useCallback(async () => {
    ...
    try {
      ...
      // fixture per product, picked in the browser, launched via
      // start-stress-batch from_fixtures) or from Claude-generated intake,
      // exactly as /admin/all-products-test. Either way the stress harness
      // generates them server-side and is polled below.
