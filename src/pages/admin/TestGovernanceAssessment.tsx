    ...
    <div className="min-h-screen bg-paper">
      <div className="max-w-5xl mx-auto px-6 py-8 space-y-6">
        ...
        {result && (
          <>
            <div className="border rounded-lg p-4 bg-card">
              <h2 className="font-serif text-xl mb-3">Assertions ({passCount} pass / {failCount} fail)</h2>
            ...
            <div className="border rounded-lg p-4 bg-card">
              <h2 className="font-serif text-xl mb-2">Executive Summary (quality check)</h2>
