      ...
      <div className="max-w-[860px] mx-auto px-4 md:px-8 py-10">
        ...
        <div className="bg-gradient-to-br from-navy to-navy-mid rounded-2xl p-6 md:p-8 text-center">
          ...
          <p className="text-[13px] text-slate-light mb-5 max-w-[500px] mx-auto">
            Get Premium for weekly analysis of enforcement trends, sector-specific LI risk assessments, and action items tailored to your industry and jurisdictions.
          </p>
