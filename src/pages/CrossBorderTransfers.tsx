        ...
        {recentUpdates.length > 0 && (
          <section className="mt-12 border-t border-border pt-8">
            ...
            <div className="space-y-3">
              {recentUpdates.map(u => (
                <a key={u.id} href={u.url} target="_blank" rel="noopener noreferrer" className="flex items-start gap-3 p-3 rounded-lg border border-border hover:bg-muted/40 no-underline transition-all">
                  <div>
