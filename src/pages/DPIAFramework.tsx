...
// RC-C2 C2.2 — intake option sets exported for the refine surface T-class registry.
// Do NOT retype these literals in fieldEnums.ts; import them from this module so
// the refine surface tracks the intake page 1:1.
