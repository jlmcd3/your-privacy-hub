...
const GetIntelligence = () => (
  <div className="min-h-screen bg-paper">
    <Helmet>
      <title>Build Your Sample Intelligence Brief | End User Privacy</title>
      <meta
        name="description"
        content="Choose your jurisdiction, role, and topic tracks to preview the Monday Intelligence Brief format — written for your practice."
      />
    </Helmet>
    <Navbar />
    <main className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-10 md:py-14">
      <header className="mb-8">
        ...
        <h1 className="font-display font-bold text-navy text-[28px] md:text-[34px] leading-tight mb-3">
