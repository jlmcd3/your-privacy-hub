...
const SECTIONS = [
  {
    ...
    content: `The <a href="https://www.hhs.gov/hipaa/index.html" target="_blank" rel="noopener noreferrer">Health Insurance Portability and Accountability Act (HIPAA)</a> remains the cornerstone of U.S. health data privacy. Its <a href="https://www.hhs.gov/hipaa/for-professionals/privacy/index.html" target="_blank" rel="noopener noreferrer">Privacy Rule (45 CFR Part 160 and Subparts A, E of Part 164)</a> and <a href="https://www.hhs.gov/hipaa/for-professionals/security/index.html" target="_blank" rel="noopener noreferrer">Security Rule</a> govern the use and disclosure of Protected Health Information (PHI) by covered entities (health plans, healthcare providers, healthcare clearinghouses) and their business associates.\n\nKey obligations include:\n• **Minimum Necessary Standard** — access only the PHI reasonably necessary for the intended purpose\n• **<a href="https://www.hhs.gov/hipaa/for-professionals/covered-entities/sample-business-associate-agreement-provisions/index.html" target="_blank" rel="noopener noreferrer">Business Associate Agreements (BAAs)</a>** — required for any vendor that creates, receives, maintains, or transmits PHI\n• **<a href="https://www.hhs.gov/hipaa/for-professionals/breach-notification/index.html" target="_blank" rel="noopener noreferrer">Breach Notification Rule</a>** — notify HHS, affected individuals, and potentially media within 60 days of discovering a breach of unsecured PHI\n• **Right of Access** — patients can request copies of their PHI within 30 days\n\nHHS OCR enforces HIPAA through audits, complaint investigations, and civil monetary penalties ranging from $100 to $50,000 per violation (up to $2M annually per violation category).`,
  },
  {
    heading: "FTC Health Breach Notification Rule",
    content: `The <a href="https://www.ftc.gov/legal-library/browse/rules/health-breach-notification-rule" target="_blank" rel="noopener noreferrer">FTC's Health Breach Notification Rule (16 CFR Part 318)</a> fills a critical gap: it covers health data held by entities NOT subject to HIPAA — including health apps, fitness trackers, and direct-to-consumer health platforms.\n\nIn 2023-2025, the FTC significantly expanded enforcement of this rule:\n• **GoodRx** — $1.5M penalty for sharing health data with advertising platforms without consumer consent\n• **BetterHelp** — $7.8M settlement for sharing therapy session data with Facebook and Snapchat for advertising\n• **Premom** — consent order for sharing fertility data with third-party analytics\n\nThe rule requires notification to the FTC, affected individuals, and prominent media within 60 days of a breach of health data. "Breach" is defined broadly to include unauthorized sharing, not just security incidents.`,
  },
  {
    heading: "State Consumer Health Data Laws",
    content: `A new wave of state laws now extends health data protections beyond HIPAA:\n\n**<a href="https://app.leg.wa.gov/rcw/default.aspx?cite=70.372" target="_blank" rel="noopener noreferrer">Washington My Health My Data Act (MHMDA)</a>** — Effective March 2024, this is the most comprehensive state health data law. It:\n• Applies to any entity that collects, processes, or shares consumer health data (not limited to covered entities)\n• Requires clear consent before collection or sharing\n• Grants a private right of action (unlike most state privacy laws)\n• Covers reproductive health, mental health, gender-affirming care data, and biometric data\n\n**<a href="https://www.leg.state.nv.us/App/NELIS/REL/82nd2023/Bill/SB370/Overview" target="_blank" rel="noopener noreferrer">Nevada SB 370</a>** — Similar consumer health data protections effective 2024.\n\n**Connecticut, Oregon, Montana** — Each includes health data provisions in their comprehensive privacy laws, with varying definitions and consent requirements.\n\n**Reproductive Health Data** — Following the <a href="https://www.supremecourt.gov/opinions/21pdf/19-1392_6j37.pdf" target="_blank" rel="noopener noreferrer">Dobbs decision</a>, multiple states (CA, IL, MD, WA) enacted specific protections for reproductive and sexual health data, restricting law enforcement access and requiring heightened consent for collection.`,
  },
  {
