        ...
        <div className="w-full max-w-lg bg-card border border-fog rounded-2xl shadow-eup-sm p-8">
          ...
          <form onSubmit={handleSave} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={saving}
              className="w-full py-3 mt-2 text-[14px] font-semibold text-white bg-gradient-to-br from-steel to-blue rounded-lg shadow-[0_2px_8px_rgba(59,130,196,0.25)] hover:opacity-90 hover:-translate-y-px transition-all disabled:opacity-50 cursor-pointer border-none"
            >
