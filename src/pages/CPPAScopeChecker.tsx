  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <ProductInfoCards
        ...
        cards={[
          {
            title: "Which obligations are in scope?",
            tone: "amber",
            body: "The CCPA/CPRA applies on revenue and data-volume thresholds. Clearing them can pull in the risk assessment, cybersecurity audit, and ADMT obligations, each with its own deadline.",
          },
          {
            title: "What you receive",
            body: "An indicative obligation map for your business — which CPPA obligations apply, and by when — in about two minutes.",
          },
          {
            title: "Free, no account required",
            body: "The check runs deterministically from the thresholds in Cal. Civ. Code § 1798.140(d)(1) and 11 CCR §§ 7120, 7150. Nothing is generated by a model.",
          },
        ]}
      />
      ...
      <main className="flex-1 max-w-[1280px] w-full mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-6">
        <CompactDisclaimer
          line="Indicative scope check only — not legal advice."
          addition="This checker provides an indicative obligation map based on your answers. Applicability thresholds under the CCPA/CPRA are fact-specific; confirm scope conclusions with qualified counsel." />
