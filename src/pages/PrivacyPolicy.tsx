      ...
      <main className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20">
        ...
        <div className="prose prose-sm max-w-none text-foreground/90 space-y-8">
          <section className="space-y-3">
            <h2 className="font-display font-semibold text-foreground">Introduction</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="font-display font-semibold text-foreground">1. Who We Are</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="font-display font-semibold text-foreground">8. Your Rights</h2>
          ...
          <section className="space-y-3">
            <h2 className="font-display font-semibold text-foreground">11. Security</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="font-display font-semibold text-foreground">14. Contact Us</h2>
            <p>
