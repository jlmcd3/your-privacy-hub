...
const GovernanceAssessment = () => {
  ...
  const govRailConfigs: Record<number, Parameters<typeof useGdprRailEntry>[0]> = {
    1: {
      ...
      coachLead: "Answer from your data flows, not your incorporation.",
      coachBody: "Art. 3 catches you if you have an EU establishment, if you offer goods or services to people in the EU, or if you monitor their behaviour. A US-only address doesn't take you out of scope.",
      goodAnswer: "A US SaaS runs an EU-language site, prices in Euros, and ships to EU customers. It selects in-scope — the targeting is the trigger, wherever the servers sit.",
      commonMistake: "Answering 'no EU office, so no GDPR'. Offering and monitoring pull you in without an office.",
    },
    2: {
      ...
      coachLead: "Check the Art. 9 list against every field you actually hold.",
      coachBody: "Health, biometrics used to identify, race or ethnic origin, trade-union membership, sexual orientation, and religion are the categories. Answer from the inventory, not the intake form.",
      goodAnswer: "A wellness app stores steps and heart-rate. It selects yes — heart-rate is health data, however routine the UI makes it feel.",
      commonMistake: "Answering no because you don't market yourself as a health service. The category tracks the data, not the branding.",
    },
    3: {
      ...
      coachLead: "Test each Art. 37(1) trigger against your core activities.",
      coachBody: "Core activities are the primary business — not the HR or IT that supports them. Large-scale monitoring or special-category processing at that core level triggers the appointment.",
      goodAnswer: "An adtech firm builds behavioural profiles at scale as its core service. It selects DPO required under Art. 37(1)(b) — systematic monitoring is the business.",
      commonMistake: "Reading 'core activities' to mean everything the company does. Payroll and internal IT are ancillary, not core.",
    },
    4: {
      ...
      coachLead: "Answer for measures that exist in production, not on the roadmap.",
      coachBody: "Art. 32 is measured against actual risk — encryption at rest and in transit, access controls, tested restoration, and staff instruction under Art. 32(4). Say which controls are live.",
      goodAnswer: "A firm reports AES-256 at rest, TLS 1.3 in transit, quarterly restore tests, and annual staff training with sign-off. That is the shape of an Art. 32 answer.",
      commonMistake: "Listing planned or vendor-default controls without knowing which are actually enabled and tested.",
    },
    5: {
