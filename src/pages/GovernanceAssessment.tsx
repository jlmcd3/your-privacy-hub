        ...
        <div className="bg-card border rounded-lg p-6 space-y-6">
          ...
          {step === 3 && (
            <>
              ...
              <div><Label>Q9: Acceptable use policy for technology tools<Req /> <DefPopover termKey="gdpr_lawful_basis" /></Label><div className="mt-2"><Radio name="aup" options={["Yes, covers external technology tools specifically", "Yes, but general only", "No"]} value={acceptableUse} onChange={setAcceptableUse} /></div></div>
