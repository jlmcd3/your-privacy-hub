...
| Kind | Path | Purpose |
| --- | --- | --- |
| new | `supabase/functions/run-li-assessment/_local/registry/lia-verified-authorities.ts` | Registry data (16 rows + 22-item unanchorable list + empty paraphrase list) |
