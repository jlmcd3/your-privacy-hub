...
10. **NEXT** — `SAMPLES-CONTRACT-ir_playbook` (7/8). Frontend/test only; not deploy-locked. Continues the samples series per dispatch pattern.
11. Then — `SAMPLES-CONTRACT-biometric` (8/8), then `SAMPLES-CONTRACT-dpa` closes the series.
