...
Deno.test("C3/S4.1: both v4.7 hash bases recompute to the shipped pins", async () => {
  ...
  // RE-PIN 2026-09-19 (doc 275 §15 items 1, 2, 4): v4.14 — the controller
  // contact, prepared-by and other-safeguards sentences; both bases recompute.
  assertEquals(DPIA_SKELETON_VERSION, "dpia-v4.14-2026-09-19");
});
