...
// DOC 152 (2026-09-03) — re-pinned for the batch-9 amendments (recipient
// contract-status + benefit-weight semantics; framework-prose and
// condition-deadline rubric recalibrations).
// DOC 165 (2026-09-04) — re-pinned for the batch-08f13650 triage (cppa_risk
// choice-architecture confirmed/unconfirmed sentence, fixed-methodology
// Section 1 restatement, and the "is not identified" trigger-row phrasing).
// DOC 167 (2026-09-04) — re-pinned for the batch-52f83146 / A-Team Batch 13
// triage (six cppa_risk false-positive classes: credentials as sensitive PI,
// the executive Conditions digest, the Do-Not-Proceed frame, § 7150(b)(1) on
// advertising sharing, the § 3.E recital, attribution-register sentences).
// DOC 169 (2026-09-04) — re-pinned for the batch-50b8bcd4 triage:
// cal_skeleton_7/8/9 (ratified fixed frames, truncation claims against a
...
// RE-PIN 2026-09-08 (found stale while landing DOC 211/218's cal_skeleton_12:
// this pin was already missing the doc189-device-access-relevance-2026-09-05
// tag that had shipped on 2026-09-05, before today's session touched this
// file — a pre-existing staleness, not a regression from today's edit).
...
// RE-PIN 2026-09-10 (DOC 252, batch 916c33a8): "+batch-916c33a8-cal-2026-09-10"
// — three prose false-positive classes + the § 1798.140 definition-lettering
// line in the VERIFIED-ANCHOR MAP (prose only).
// RE-PIN 2026-09-11 (DOC 252 §10 rulings): "+doc252-rulings-2026-09-11" —
// DOC 251 (4) rewritten for the Q9 "Credited — footer placement" treatment
// (prose only).
// RE-PIN 2026-09-11 (DOC 253, batch bcf0a706): "+batch-bcf0a706-cal-2026-09-11"
// — eight prose false-positive classes across seven products (prose only).
// RE-PIN 2026-09-11 (DOC 254, ChatGPT prose review): "+doc254-chatgpt-review-2026-09-11"
// — eight designed states introduced by the review's accepted items (prose only).
Deno.test("instrument version pinned to the skeleton-calibration epoch", () => {
  assertEquals(
    GRADER_CONTEXT_VERSION,
    "gc-2026-08-28-skeleton-cal-3-item204[cal_skeleton_1|cal_skeleton_2|cal_skeleton_3|cal_skeleton_4|cal_skeleton_5|cal_skeleton_6]+risk-field-semantics-2026-09-03+batch9-cal-2026-09-03+batch10-cal-2026-09-03+risk-code-review-2026-09-03+risk-law-map-2026-09-03+admt-law-map-2026-09-03+cyber-law-map-2026-09-03+dpia-law-map-2026-09-03+lia-law-map-2026-09-03+gov-law-map-2026-09-03+registration-law-map-2026-09-03+gov-dpa2018-wp243-2026-09-04+batch08f13650-cal-2026-09-04+batch13-cal-2026-09-04+skeleton-cal-4-doc169[cal_skeleton_7|cal_skeleton_8|cal_skeleton_9]+batch14-cal-2026-09-04+skeleton-cal-5-doc188[cal_skeleton_10|cal_skeleton_11]+batch-e38460-cal-2026-09-05+doc189-device-access-relevance-2026-09-05+batch-a81e0240-cal-2026-09-07[cal_skeleton_12]+lia-v3-hooks-grader-2026-09-08+batch-e74fdbfd-cal-2026-09-09+doc250-eprivacy-overlay-2026-09-10+batch-7bd29982-cal-2026-09-10+batch-916c33a8-cal-2026-09-10+doc252-rulings-2026-09-11+batch-bcf0a706-cal-2026-09-11+doc254-chatgpt-review-2026-09-11+batch-e2e1185b-cal-2026-09-11+doc258-q9-homepage-2026-09-11+batch-c4d0b8a0-cal-2026-09-12",
  );
});
