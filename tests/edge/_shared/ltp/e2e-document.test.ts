...
import { INTERPOLATION_RESIDUE_PATTERNS } from "../../../../supabase/functions/run-cppa-risk-assessment/_local/ltp/pass2-render.ts";
import { composeSection } from "../../../../supabase/functions/run-cppa-risk-assessment/_local/ltp/section-composers/cppa-risk.ts";
import { chooseVariant } from "../../../../supabase/functions/run-cppa-risk-assessment/_local/ltp/closeness.ts";
