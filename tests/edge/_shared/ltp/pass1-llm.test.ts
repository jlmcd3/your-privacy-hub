...
import { runPass1Llm, PASS1_ABORT_TIMEOUT_ERROR } from "../../../../supabase/functions/run-cppa-risk-assessment/_local/ltp/pass1-llm.ts";
...
Deno.test({ name: "pass1-llm: model-emitted triggered=true is IGNORED on validator-clean ok", sanitizeOps: false, sanitizeResources: false, fn: async () => {
  const { derivePlan } = await import("../../../../supabase/functions/run-cppa-risk-assessment/_local/ltp/derive.ts");
