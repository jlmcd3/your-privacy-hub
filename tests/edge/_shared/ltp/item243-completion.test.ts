...
import { screenPresentNoteCoherence } from "../../../../supabase/functions/run-cppa-risk-assessment/_local/ltp/pass1-present-note-coherence.ts";
import { evaluateCppaRiskGates, FIELD_ALIASES } from "../../../../supabase/functions/run-cppa-risk-assessment/_local/ltp/gate-eval.ts";
import type { FactorTableEntry, RenderPlan } from "../../../../supabase/functions/run-cppa-risk-assessment/_local/render-plan/schema.ts";
import { RECORD_STATUS_CLAUSES } from "../../../../supabase/functions/run-cppa-risk-assessment/_local/ltp/content/pass2-templates.ts";
...
Deno.test("defect 5 — factual gate id set defines exactly the four § 7152(a) documentation gates", async () => {
  const mod = await import("../../../../supabase/functions/run-cppa-risk-assessment/_local/ltp/section-composers/cppa-risk.ts");
